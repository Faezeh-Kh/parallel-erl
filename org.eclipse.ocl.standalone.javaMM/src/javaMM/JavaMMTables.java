 ...
 * from:
 *   /org.eclipse.ocl.standalone.javaMM/model/java_findbugs.ecore
 * using:
 *   /org.eclipse.ocl.standalone.javaMM/model/java_findbugs.genmodel
...
/**
 * JavaMMTables provides the dispatch tables for the javaMM for use by the OCL dispatcher.
 *
 * In order to ensure correct static initialization, a top level class element must be accessed
 * before any nested class element. Therefore an access to PACKAGE.getClass() is recommended.
 */
public class JavaMMTables
{
	static {
		Init.initStart();
	}
	 ...
	 */
	public static final /*@NonNull*/ EcoreExecutorPackage PACKAGE = new EcoreExecutorPackage(JavaMMPackage.eINSTANCE);
	...
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.NsURIPackageId PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java = org.eclipse.ocl.pivot.ids.IdManager.getNsURIPackageId("http://www.eclipse.org/MoDisco/Java/0.2.incubation/java", null, javaMM.JavaMMPackage.eINSTANCE);
	...
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ASTNode = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ASTNode", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AbstractMethodDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AbstractMethodDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AbstractMethodInvocation = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AbstractMethodInvocation", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AbstractTypeDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AbstractTypeDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AbstractTypeQualifiedExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AbstractTypeQualifiedExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AbstractVariablesContainer = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AbstractVariablesContainer", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Annotation = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Annotation", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AnnotationMemberValuePair = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AnnotationMemberValuePair", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AnnotationTypeMemberDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AnnotationTypeMemberDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AnonymousClassDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AnonymousClassDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Archive = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Archive", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ArrayAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ArrayAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ArrayCreation = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ArrayCreation", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ArrayInitializer = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ArrayInitializer", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ArrayLengthAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ArrayLengthAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ArrayType = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ArrayType", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_AssertStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("AssertStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Assignment = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Assignment", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Block = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Block", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_BodyDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("BodyDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_BooleanLiteral = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("BooleanLiteral", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_BreakStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("BreakStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_CastExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("CastExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_CatchClause = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("CatchClause", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_CharacterLiteral = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("CharacterLiteral", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Class = javaMM.JavaMMTables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ClassDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ClassDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ClassFile = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ClassFile", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ClassInstanceCreation = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ClassInstanceCreation", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Comment = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Comment", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_CompilationUnit = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("CompilationUnit", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ConditionalExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ConditionalExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ContinueStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ContinueStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_DoStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("DoStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_EmptyStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("EmptyStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_EnhancedForStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("EnhancedForStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_EnumConstantDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("EnumConstantDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_EnumDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("EnumDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Expression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Expression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ExpressionStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ExpressionStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_FieldAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("FieldAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_FieldDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("FieldDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ForStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ForStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_IfStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("IfStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ImportDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ImportDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_InfixExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("InfixExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Initializer = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Initializer", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_InstanceofExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("InstanceofExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Javadoc = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Javadoc", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_LabeledStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("LabeledStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Manifest = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Manifest", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ManifestAttribute = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ManifestAttribute", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ManifestEntry = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ManifestEntry", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_MemberRef = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("MemberRef", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_MethodDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("MethodDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_MethodInvocation = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("MethodInvocation", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_MethodRef = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("MethodRef", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_MethodRefParameter = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("MethodRefParameter", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Model = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Model", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Modifier = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Modifier", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_NamedElement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("NamedElement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_NamespaceAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("NamespaceAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_NullLiteral = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("NullLiteral", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_NumberLiteral = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("NumberLiteral", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Package = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Package", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_PackageAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("PackageAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ParameterizedType = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ParameterizedType", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ParenthesizedExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ParenthesizedExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_PostfixExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("PostfixExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_PrefixExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("PrefixExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_PrimitiveTypeBoolean = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("PrimitiveTypeBoolean", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_PrimitiveTypeInt = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("PrimitiveTypeInt", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_PrimitiveTypeLong = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("PrimitiveTypeLong", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ReturnStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ReturnStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_SingleVariableAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("SingleVariableAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_SingleVariableDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("SingleVariableDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Statement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Statement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_StringLiteral = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("StringLiteral", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_SuperConstructorInvocation = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("SuperConstructorInvocation", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_SuperFieldAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("SuperFieldAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_SwitchCase = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("SwitchCase", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_SwitchStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("SwitchStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_SynchronizedStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("SynchronizedStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_TagElement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("TagElement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_ThrowStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("ThrowStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_TryStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("TryStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_Type = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("Type", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_TypeAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("TypeAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_TypeDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("TypeDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_TypeDeclarationStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("TypeDeclarationStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_TypeLiteral = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("TypeLiteral", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_TypeParameter = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("TypeParameter", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_UnresolvedItem = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("UnresolvedItem", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_UnresolvedItemAccess = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("UnresolvedItemAccess", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_VariableDeclaration = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("VariableDeclaration", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_VariableDeclarationExpression = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("VariableDeclarationExpression", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_VariableDeclarationFragment = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("VariableDeclarationFragment", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_VariableDeclarationStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("VariableDeclarationStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_WhileStatement = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("WhileStatement", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.ClassId CLSSid_WildCardType = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getClassId("WildCardType", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.DataTypeId DATAid_EInt = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_emf_s_2002_s_Ecore.getDataTypeId("EInt", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationId ENUMid_AssignmentKind = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getEnumerationId("AssignmentKind");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationId ENUMid_InfixExpressionKind = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getEnumerationId("InfixExpressionKind");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationId ENUMid_InheritanceKind = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getEnumerationId("InheritanceKind");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationId ENUMid_PostfixExpressionKind = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getEnumerationId("PostfixExpressionKind");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationId ENUMid_PrefixExpressionKind = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getEnumerationId("PrefixExpressionKind");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationId ENUMid_VisibilityKind = javaMM.JavaMMTables.PACKid_http_c_s_s_www_eclipse_org_s_MoDisco_s_Java_s_0_2_incubation_s_java.getEnumerationId("VisibilityKind");
	...
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.IntegerValue INT_3 = org.eclipse.ocl.pivot.utilities.ValueUtil.integerValueOf("3");
	public static final /*@NonInvalid*/ java.lang.String STR_AbstractMethodDeclaration_c_c_localMethodIsUsed = "AbstractMethodDeclaration::localMethodIsUsed";
	public static final /*@NonInvalid*/ java.lang.String STR_AbstractMethodDeclaration_c_c_parametersEffectivelyFinal = "AbstractMethodDeclaration::parametersEffectivelyFinal";
	public static final /*@NonInvalid*/ java.lang.String STR_Assignment_c_c_noRedundantAssignment = "Assignment::noRedundantAssignment";
	public static final /*@NonInvalid*/ java.lang.String STR_Block_c_c_emptyBlockIsDocumented = "Block::emptyBlockIsDocumented";
	public static final /*@NonInvalid*/ java.lang.String STR_CatchClause_c_c_doesNotCatchDubiousExceptions = "CatchClause::doesNotCatchDubiousExceptions";
	public static final /*@NonInvalid*/ java.lang.String STR_CatchClause_c_c_exceptionIsUsed = "CatchClause::exceptionIsUsed";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_cloneInCloneable = "ClassDeclaration::cloneInCloneable";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_comparatorImplementsSerializable = "ClassDeclaration::comparatorImplementsSerializable";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_equalsAndCompareTo = "ClassDeclaration::equalsAndCompareTo";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_hashCodeAndEquals = "ClassDeclaration::hashCodeAndEquals";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_noCovariantCompareTo = "ClassDeclaration::noCovariantCompareTo";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_noCovariantEquals = "ClassDeclaration::noCovariantEquals";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_noObscuredVariables = "ClassDeclaration::noObscuredVariables";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_noRedundantInterfaceImpl = "ClassDeclaration::noRedundantInterfaceImpl";
	public static final /*@NonInvalid*/ java.lang.String STR_ClassDeclaration_c_c_serialUIDInSerializableClass = "ClassDeclaration::serialUIDInSerializableClass";
	public static final /*@NonInvalid*/ java.lang.String STR_CloneNotSupportedException = "CloneNotSupportedException";
	public static final /*@NonInvalid*/ java.lang.String STR_Cloneable = "Cloneable";
	public static final /*@NonInvalid*/ java.lang.String STR_Comparator = "Comparator";
	public static final /*@NonInvalid*/ java.lang.String STR_IfStatement_c_c_noDeadCode = "IfStatement::noDeadCode";
	public static final /*@NonInvalid*/ java.lang.String STR_IfStatement_c_c_noUselessControlFlow = "IfStatement::noUselessControlFlow";
	public static final /*@NonInvalid*/ java.lang.String STR_IllegalMonitorStateException = "IllegalMonitorStateException";
	public static final /*@NonInvalid*/ java.lang.String STR_InfixExpression_c_c_equalsNotOnLiterals = "InfixExpression::equalsNotOnLiterals";
	public static final /*@NonInvalid*/ java.lang.String STR_InfixExpression_c_c_equalsNotOnStrings = "InfixExpression::equalsNotOnStrings";
	public static final /*@NonInvalid*/ java.lang.String STR_InfixExpression_c_c_noRedundantComparison = "InfixExpression::noRedundantComparison";
	public static final /*@NonInvalid*/ java.lang.String STR_MethodDeclaration_c_c_shouldStartWithLowerCase = "MethodDeclaration::shouldStartWithLowerCase";
	public static final /*@NonInvalid*/ java.lang.String STR_MethodInvocation_c_c_doesNotCallExit = "MethodInvocation::doesNotCallExit";
	public static final /*@NonInvalid*/ java.lang.String STR_MethodInvocation_c_c_doesNotCallFinalize = "MethodInvocation::doesNotCallFinalize";
	public static final /*@NonInvalid*/ java.lang.String STR_MethodInvocation_c_c_doesNotCallRunFinalizers = "MethodInvocation::doesNotCallRunFinalizers";
	public static final /*@NonInvalid*/ java.lang.String STR_Object = "Object";
	public static final /*@NonInvalid*/ java.lang.String STR_Serializable = "Serializable";
	public static final /*@NonInvalid*/ java.lang.String STR_SuperConstructorInvocation_c_c_noRedundantSuperCall = "SuperConstructorInvocation::noRedundantSuperCall";
	public static final /*@NonInvalid*/ java.lang.String STR_SwitchStatement_c_c_moreThan3Cases = "SwitchStatement::moreThan3Cases";
	public static final /*@NonInvalid*/ java.lang.String STR_SynchronizedStatement_c_c_hasStatements = "SynchronizedStatement::hasStatements";
	public static final /*@NonInvalid*/ java.lang.String STR_VariableDeclarationExpression_c_c_publicVariableIsFinal = "VariableDeclarationExpression::publicVariableIsFinal";
	public static final /*@NonInvalid*/ java.lang.String STR_VariableDeclarationStatement_c_c_publicVariableIsFinal = "VariableDeclarationStatement::publicVariableIsFinal";
	public static final /*@NonInvalid*/ java.lang.String STR_VariableDeclaration_c_c_variableIsUsed = "VariableDeclaration::variableIsUsed";
	public static final /*@NonInvalid*/ java.lang.String STR_clone = "clone";
	public static final /*@NonInvalid*/ java.lang.String STR_compareTo = "compareTo";
	public static final /*@NonInvalid*/ java.lang.String STR_equals = "equals";
	public static final /*@NonInvalid*/ java.lang.String STR_exit = "exit";
	public static final /*@NonInvalid*/ java.lang.String STR_finalize = "finalize";
	public static final /*@NonInvalid*/ java.lang.String STR_hashCode = "hashCode";
	public static final /*@NonInvalid*/ java.lang.String STR_runFinalizersOnExit = "runFinalizersOnExit";
	public static final /*@NonInvalid*/ java.lang.String STR_serialVersionUID = "serialVersionUID";
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId BAG_CLSSid_ASTNode = org.eclipse.ocl.pivot.ids.TypeId.BAG.getSpecializedId(javaMM.JavaMMTables.CLSSid_ASTNode);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId BAG_CLSSid_ClassFile = org.eclipse.ocl.pivot.ids.TypeId.BAG.getSpecializedId(javaMM.JavaMMTables.CLSSid_ClassFile);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId BAG_CLSSid_CompilationUnit = org.eclipse.ocl.pivot.ids.TypeId.BAG.getSpecializedId(javaMM.JavaMMTables.CLSSid_CompilationUnit);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId BAG_CLSSid_MemberRef = org.eclipse.ocl.pivot.ids.TypeId.BAG.getSpecializedId(javaMM.JavaMMTables.CLSSid_MemberRef);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId BAG_CLSSid_UnresolvedItemAccess = org.eclipse.ocl.pivot.ids.TypeId.BAG.getSpecializedId(javaMM.JavaMMTables.CLSSid_UnresolvedItemAccess);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationLiteralId ELITid_ASSIGN = javaMM.JavaMMTables.ENUMid_AssignmentKind.getEnumerationLiteralId("ASSIGN");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationLiteralId ELITid_EQUALS = javaMM.JavaMMTables.ENUMid_InfixExpressionKind.getEnumerationLiteralId("EQUALS");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationLiteralId ELITid_NOT_EQUALS = javaMM.JavaMMTables.ENUMid_InfixExpressionKind.getEnumerationLiteralId("NOT_EQUALS");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationLiteralId ELITid_final = javaMM.JavaMMTables.ENUMid_InheritanceKind.getEnumerationLiteralId("final");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationLiteralId ELITid_none = javaMM.JavaMMTables.ENUMid_VisibilityKind.getEnumerationLiteralId("none");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationLiteralId ELITid_private = javaMM.JavaMMTables.ENUMid_VisibilityKind.getEnumerationLiteralId("private");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.EnumerationLiteralId ELITid_public = javaMM.JavaMMTables.ENUMid_VisibilityKind.getEnumerationLiteralId("public");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_ASTNode = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_ASTNode);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_AbstractMethodDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_AbstractMethodDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_AbstractTypeDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_AbstractTypeDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_Annotation = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_Annotation);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_AnnotationMemberValuePair = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_AnnotationMemberValuePair);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_BodyDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_BodyDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_CatchClause = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_CatchClause);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_Comment = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_Comment);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_EnumConstantDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_EnumConstantDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_Expression = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_Expression);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_ExpressionStatement = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_ExpressionStatement);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_FieldDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_FieldDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_ImportDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_ImportDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_MethodDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_MethodDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_MethodRefParameter = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_MethodRefParameter);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_SingleVariableDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_SingleVariableDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_Statement = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_Statement);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_TagElement = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_TagElement);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_TypeAccess = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_TypeAccess);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_TypeParameter = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_TypeParameter);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_VariableDeclaration = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_VariableDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId ORD_CLSSid_VariableDeclarationFragment = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_VariableDeclarationFragment);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SEQ_CLSSid_Assignment = org.eclipse.ocl.pivot.ids.TypeId.SEQUENCE.getSpecializedId(javaMM.JavaMMTables.CLSSid_Assignment);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SEQ_CLSSid_Expression = org.eclipse.ocl.pivot.ids.TypeId.SEQUENCE.getSpecializedId(javaMM.JavaMMTables.CLSSid_Expression);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_AbstractMethodInvocation = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_AbstractMethodInvocation);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_AbstractTypeDeclaration = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_AbstractTypeDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_AnnotationMemberValuePair = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_AnnotationMemberValuePair);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_Archive = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_Archive);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_BreakStatement = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_BreakStatement);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_ClassFile = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_ClassFile);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_CompilationUnit = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_CompilationUnit);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_ContinueStatement = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_ContinueStatement);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_ImportDeclaration = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_ImportDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_ManifestAttribute = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_ManifestAttribute);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_ManifestEntry = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_ManifestEntry);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_MethodDeclaration = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_MethodDeclaration);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_MethodRef = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_MethodRef);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_Package = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_Package);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_PackageAccess = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_PackageAccess);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_SingleVariableAccess = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_SingleVariableAccess);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_Type = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_Type);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_TypeAccess = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_TypeAccess);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.CollectionTypeId SET_CLSSid_UnresolvedItem = org.eclipse.ocl.pivot.ids.TypeId.SET.getSpecializedId(javaMM.JavaMMTables.CLSSid_UnresolvedItem);
	...
	public static class TypeParameters {
		...
		/**
		 * Force initialization of the fields of JavaMMTables::TypeParameters and all preceding sub-packages.
		 */
	...
	public static class Types {
		...
		public static final /*@NonNull*/ EcoreExecutorType _ASTNode = new EcoreExecutorType(JavaMMPackage.Literals.AST_NODE, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _AbstractMethodDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _AbstractMethodInvocation = new EcoreExecutorType(JavaMMPackage.Literals.ABSTRACT_METHOD_INVOCATION, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _AbstractTypeDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _AbstractTypeQualifiedExpression = new EcoreExecutorType(JavaMMPackage.Literals.ABSTRACT_TYPE_QUALIFIED_EXPRESSION, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _AbstractVariablesContainer = new EcoreExecutorType(JavaMMPackage.Literals.ABSTRACT_VARIABLES_CONTAINER, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _Annotation = new EcoreExecutorType(JavaMMPackage.Literals.ANNOTATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _AnnotationMemberValuePair = new EcoreExecutorType(JavaMMPackage.Literals.ANNOTATION_MEMBER_VALUE_PAIR, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _AnnotationTypeDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.ANNOTATION_TYPE_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _AnnotationTypeMemberDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.ANNOTATION_TYPE_MEMBER_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _AnonymousClassDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.ANONYMOUS_CLASS_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Archive = new EcoreExecutorType(JavaMMPackage.Literals.ARCHIVE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ArrayAccess = new EcoreExecutorType(JavaMMPackage.Literals.ARRAY_ACCESS, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ArrayCreation = new EcoreExecutorType(JavaMMPackage.Literals.ARRAY_CREATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ArrayInitializer = new EcoreExecutorType(JavaMMPackage.Literals.ARRAY_INITIALIZER, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ArrayLengthAccess = new EcoreExecutorType(JavaMMPackage.Literals.ARRAY_LENGTH_ACCESS, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ArrayType = new EcoreExecutorType(JavaMMPackage.Literals.ARRAY_TYPE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _AssertStatement = new EcoreExecutorType(JavaMMPackage.Literals.ASSERT_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Assignment = new EcoreExecutorType(JavaMMPackage.Literals.ASSIGNMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumeration _AssignmentKind = new EcoreExecutorEnumeration(JavaMMPackage.Literals.ASSIGNMENT_KIND, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Block = new EcoreExecutorType(JavaMMPackage.Literals.BLOCK, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _BlockComment = new EcoreExecutorType(JavaMMPackage.Literals.BLOCK_COMMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _BodyDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.BODY_DECLARATION, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _BooleanLiteral = new EcoreExecutorType(JavaMMPackage.Literals.BOOLEAN_LITERAL, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _BreakStatement = new EcoreExecutorType(JavaMMPackage.Literals.BREAK_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _CastExpression = new EcoreExecutorType(JavaMMPackage.Literals.CAST_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _CatchClause = new EcoreExecutorType(JavaMMPackage.Literals.CATCH_CLAUSE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _CharacterLiteral = new EcoreExecutorType(JavaMMPackage.Literals.CHARACTER_LITERAL, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ClassDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.CLASS_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ClassFile = new EcoreExecutorType(JavaMMPackage.Literals.CLASS_FILE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ClassInstanceCreation = new EcoreExecutorType(JavaMMPackage.Literals.CLASS_INSTANCE_CREATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Comment = new EcoreExecutorType(JavaMMPackage.Literals.COMMENT, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _CompilationUnit = new EcoreExecutorType(JavaMMPackage.Literals.COMPILATION_UNIT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ConditionalExpression = new EcoreExecutorType(JavaMMPackage.Literals.CONDITIONAL_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ConstructorDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.CONSTRUCTOR_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ConstructorInvocation = new EcoreExecutorType(JavaMMPackage.Literals.CONSTRUCTOR_INVOCATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ContinueStatement = new EcoreExecutorType(JavaMMPackage.Literals.CONTINUE_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _DoStatement = new EcoreExecutorType(JavaMMPackage.Literals.DO_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _EmptyStatement = new EcoreExecutorType(JavaMMPackage.Literals.EMPTY_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _EnhancedForStatement = new EcoreExecutorType(JavaMMPackage.Literals.ENHANCED_FOR_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _EnumConstantDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.ENUM_CONSTANT_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _EnumDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.ENUM_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Expression = new EcoreExecutorType(JavaMMPackage.Literals.EXPRESSION, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _ExpressionStatement = new EcoreExecutorType(JavaMMPackage.Literals.EXPRESSION_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _FieldAccess = new EcoreExecutorType(JavaMMPackage.Literals.FIELD_ACCESS, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _FieldDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.FIELD_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ForStatement = new EcoreExecutorType(JavaMMPackage.Literals.FOR_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _IfStatement = new EcoreExecutorType(JavaMMPackage.Literals.IF_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ImportDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.IMPORT_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _InfixExpression = new EcoreExecutorType(JavaMMPackage.Literals.INFIX_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumeration _InfixExpressionKind = new EcoreExecutorEnumeration(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumeration _InheritanceKind = new EcoreExecutorEnumeration(JavaMMPackage.Literals.INHERITANCE_KIND, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Initializer = new EcoreExecutorType(JavaMMPackage.Literals.INITIALIZER, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _InstanceofExpression = new EcoreExecutorType(JavaMMPackage.Literals.INSTANCEOF_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _InterfaceDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.INTERFACE_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Javadoc = new EcoreExecutorType(JavaMMPackage.Literals.JAVADOC, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _LabeledStatement = new EcoreExecutorType(JavaMMPackage.Literals.LABELED_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _LineComment = new EcoreExecutorType(JavaMMPackage.Literals.LINE_COMMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Manifest = new EcoreExecutorType(JavaMMPackage.Literals.MANIFEST, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ManifestAttribute = new EcoreExecutorType(JavaMMPackage.Literals.MANIFEST_ATTRIBUTE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ManifestEntry = new EcoreExecutorType(JavaMMPackage.Literals.MANIFEST_ENTRY, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _MemberRef = new EcoreExecutorType(JavaMMPackage.Literals.MEMBER_REF, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _MethodDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.METHOD_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _MethodInvocation = new EcoreExecutorType(JavaMMPackage.Literals.METHOD_INVOCATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _MethodRef = new EcoreExecutorType(JavaMMPackage.Literals.METHOD_REF, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _MethodRefParameter = new EcoreExecutorType(JavaMMPackage.Literals.METHOD_REF_PARAMETER, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Model = new EcoreExecutorType(JavaMMPackage.Literals.MODEL, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Modifier = new EcoreExecutorType(JavaMMPackage.Literals.MODIFIER, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _NamedElement = new EcoreExecutorType(JavaMMPackage.Literals.NAMED_ELEMENT, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _NamespaceAccess = new EcoreExecutorType(JavaMMPackage.Literals.NAMESPACE_ACCESS, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _NullLiteral = new EcoreExecutorType(JavaMMPackage.Literals.NULL_LITERAL, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _NumberLiteral = new EcoreExecutorType(JavaMMPackage.Literals.NUMBER_LITERAL, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Package = new EcoreExecutorType(JavaMMPackage.Literals.PACKAGE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PackageAccess = new EcoreExecutorType(JavaMMPackage.Literals.PACKAGE_ACCESS, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ParameterizedType = new EcoreExecutorType(JavaMMPackage.Literals.PARAMETERIZED_TYPE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ParenthesizedExpression = new EcoreExecutorType(JavaMMPackage.Literals.PARENTHESIZED_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PostfixExpression = new EcoreExecutorType(JavaMMPackage.Literals.POSTFIX_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumeration _PostfixExpressionKind = new EcoreExecutorEnumeration(JavaMMPackage.Literals.POSTFIX_EXPRESSION_KIND, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrefixExpression = new EcoreExecutorType(JavaMMPackage.Literals.PREFIX_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumeration _PrefixExpressionKind = new EcoreExecutorEnumeration(JavaMMPackage.Literals.PREFIX_EXPRESSION_KIND, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveType = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeBoolean = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_BOOLEAN, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeByte = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_BYTE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeChar = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_CHAR, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeDouble = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_DOUBLE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeFloat = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_FLOAT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeInt = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_INT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeLong = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_LONG, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeShort = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_SHORT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _PrimitiveTypeVoid = new EcoreExecutorType(JavaMMPackage.Literals.PRIMITIVE_TYPE_VOID, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ReturnStatement = new EcoreExecutorType(JavaMMPackage.Literals.RETURN_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _SingleVariableAccess = new EcoreExecutorType(JavaMMPackage.Literals.SINGLE_VARIABLE_ACCESS, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _SingleVariableDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Statement = new EcoreExecutorType(JavaMMPackage.Literals.STATEMENT, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _StringLiteral = new EcoreExecutorType(JavaMMPackage.Literals.STRING_LITERAL, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _SuperConstructorInvocation = new EcoreExecutorType(JavaMMPackage.Literals.SUPER_CONSTRUCTOR_INVOCATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _SuperFieldAccess = new EcoreExecutorType(JavaMMPackage.Literals.SUPER_FIELD_ACCESS, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _SuperMethodInvocation = new EcoreExecutorType(JavaMMPackage.Literals.SUPER_METHOD_INVOCATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _SwitchCase = new EcoreExecutorType(JavaMMPackage.Literals.SWITCH_CASE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _SwitchStatement = new EcoreExecutorType(JavaMMPackage.Literals.SWITCH_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _SynchronizedStatement = new EcoreExecutorType(JavaMMPackage.Literals.SYNCHRONIZED_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _TagElement = new EcoreExecutorType(JavaMMPackage.Literals.TAG_ELEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _TextElement = new EcoreExecutorType(JavaMMPackage.Literals.TEXT_ELEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ThisExpression = new EcoreExecutorType(JavaMMPackage.Literals.THIS_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _ThrowStatement = new EcoreExecutorType(JavaMMPackage.Literals.THROW_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _TryStatement = new EcoreExecutorType(JavaMMPackage.Literals.TRY_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _Type = new EcoreExecutorType(JavaMMPackage.Literals.TYPE, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _TypeAccess = new EcoreExecutorType(JavaMMPackage.Literals.TYPE_ACCESS, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _TypeDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.TYPE_DECLARATION, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _TypeDeclarationStatement = new EcoreExecutorType(JavaMMPackage.Literals.TYPE_DECLARATION_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _TypeLiteral = new EcoreExecutorType(JavaMMPackage.Literals.TYPE_LITERAL, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _TypeParameter = new EcoreExecutorType(JavaMMPackage.Literals.TYPE_PARAMETER, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedAnnotationDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_ANNOTATION_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedAnnotationTypeMemberDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_ANNOTATION_TYPE_MEMBER_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedClassDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_CLASS_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedEnumDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_ENUM_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedInterfaceDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_INTERFACE_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedItem = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_ITEM, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedItemAccess = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_ITEM_ACCESS, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedLabeledStatement = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_LABELED_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedMethodDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_METHOD_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedSingleVariableDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_SINGLE_VARIABLE_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedType = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_TYPE, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedTypeDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_TYPE_DECLARATION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _UnresolvedVariableDeclarationFragment = new EcoreExecutorType(JavaMMPackage.Literals.UNRESOLVED_VARIABLE_DECLARATION_FRAGMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _VariableDeclaration = new EcoreExecutorType(JavaMMPackage.Literals.VARIABLE_DECLARATION, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final /*@NonNull*/ EcoreExecutorType _VariableDeclarationExpression = new EcoreExecutorType(JavaMMPackage.Literals.VARIABLE_DECLARATION_EXPRESSION, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _VariableDeclarationFragment = new EcoreExecutorType(JavaMMPackage.Literals.VARIABLE_DECLARATION_FRAGMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _VariableDeclarationStatement = new EcoreExecutorType(JavaMMPackage.Literals.VARIABLE_DECLARATION_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumeration _VisibilityKind = new EcoreExecutorEnumeration(JavaMMPackage.Literals.VISIBILITY_KIND, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _WhileStatement = new EcoreExecutorType(JavaMMPackage.Literals.WHILE_STATEMENT, PACKAGE, 0);
		public static final /*@NonNull*/ EcoreExecutorType _WildCardType = new EcoreExecutorType(JavaMMPackage.Literals.WILD_CARD_TYPE, PACKAGE, 0);
		...
		/**
		 * Force initialization of the fields of JavaMMTables::Types and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Fragments {
		...
		private static final /*@NonNull*/ ExecutorFragment _ASTNode__ASTNode = new ExecutorFragment(Types._ASTNode, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _AbstractMethodDeclaration__ASTNode = new ExecutorFragment(Types._AbstractMethodDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AbstractMethodDeclaration__AbstractMethodDeclaration = new ExecutorFragment(Types._AbstractMethodDeclaration, JavaMMTables.Types._AbstractMethodDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AbstractMethodDeclaration__BodyDeclaration = new ExecutorFragment(Types._AbstractMethodDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AbstractMethodDeclaration__NamedElement = new ExecutorFragment(Types._AbstractMethodDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _AbstractMethodInvocation__ASTNode = new ExecutorFragment(Types._AbstractMethodInvocation, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AbstractMethodInvocation__AbstractMethodInvocation = new ExecutorFragment(Types._AbstractMethodInvocation, JavaMMTables.Types._AbstractMethodInvocation);
		...
		private static final /*@NonNull*/ ExecutorFragment _AbstractTypeDeclaration__ASTNode = new ExecutorFragment(Types._AbstractTypeDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AbstractTypeDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._AbstractTypeDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AbstractTypeDeclaration__BodyDeclaration = new ExecutorFragment(Types._AbstractTypeDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AbstractTypeDeclaration__NamedElement = new ExecutorFragment(Types._AbstractTypeDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _AbstractTypeDeclaration__Type = new ExecutorFragment(Types._AbstractTypeDeclaration, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _AbstractTypeQualifiedExpression__ASTNode = new ExecutorFragment(Types._AbstractTypeQualifiedExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AbstractTypeQualifiedExpression__AbstractTypeQualifiedExpression = new ExecutorFragment(Types._AbstractTypeQualifiedExpression, JavaMMTables.Types._AbstractTypeQualifiedExpression);
		private static final /*@NonNull*/ ExecutorFragment _AbstractTypeQualifiedExpression__Expression = new ExecutorFragment(Types._AbstractTypeQualifiedExpression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _AbstractVariablesContainer__ASTNode = new ExecutorFragment(Types._AbstractVariablesContainer, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AbstractVariablesContainer__AbstractVariablesContainer = new ExecutorFragment(Types._AbstractVariablesContainer, JavaMMTables.Types._AbstractVariablesContainer);
		...
		private static final /*@NonNull*/ ExecutorFragment _Annotation__ASTNode = new ExecutorFragment(Types._Annotation, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Annotation__Annotation = new ExecutorFragment(Types._Annotation, JavaMMTables.Types._Annotation);
		private static final /*@NonNull*/ ExecutorFragment _Annotation__Expression = new ExecutorFragment(Types._Annotation, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _AnnotationMemberValuePair__ASTNode = new ExecutorFragment(Types._AnnotationMemberValuePair, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationMemberValuePair__AnnotationMemberValuePair = new ExecutorFragment(Types._AnnotationMemberValuePair, JavaMMTables.Types._AnnotationMemberValuePair);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationMemberValuePair__NamedElement = new ExecutorFragment(Types._AnnotationMemberValuePair, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeDeclaration__ASTNode = new ExecutorFragment(Types._AnnotationTypeDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._AnnotationTypeDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeDeclaration__AnnotationTypeDeclaration = new ExecutorFragment(Types._AnnotationTypeDeclaration, JavaMMTables.Types._AnnotationTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeDeclaration__BodyDeclaration = new ExecutorFragment(Types._AnnotationTypeDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeDeclaration__NamedElement = new ExecutorFragment(Types._AnnotationTypeDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeDeclaration__Type = new ExecutorFragment(Types._AnnotationTypeDeclaration, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeMemberDeclaration__ASTNode = new ExecutorFragment(Types._AnnotationTypeMemberDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeMemberDeclaration__AnnotationTypeMemberDeclaration = new ExecutorFragment(Types._AnnotationTypeMemberDeclaration, JavaMMTables.Types._AnnotationTypeMemberDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeMemberDeclaration__BodyDeclaration = new ExecutorFragment(Types._AnnotationTypeMemberDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _AnnotationTypeMemberDeclaration__NamedElement = new ExecutorFragment(Types._AnnotationTypeMemberDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _AnonymousClassDeclaration__ASTNode = new ExecutorFragment(Types._AnonymousClassDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AnonymousClassDeclaration__AnonymousClassDeclaration = new ExecutorFragment(Types._AnonymousClassDeclaration, JavaMMTables.Types._AnonymousClassDeclaration);
		...
		private static final /*@NonNull*/ ExecutorFragment _Archive__ASTNode = new ExecutorFragment(Types._Archive, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Archive__Archive = new ExecutorFragment(Types._Archive, JavaMMTables.Types._Archive);
		private static final /*@NonNull*/ ExecutorFragment _Archive__NamedElement = new ExecutorFragment(Types._Archive, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ArrayAccess__ASTNode = new ExecutorFragment(Types._ArrayAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ArrayAccess__ArrayAccess = new ExecutorFragment(Types._ArrayAccess, JavaMMTables.Types._ArrayAccess);
		private static final /*@NonNull*/ ExecutorFragment _ArrayAccess__Expression = new ExecutorFragment(Types._ArrayAccess, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ArrayCreation__ASTNode = new ExecutorFragment(Types._ArrayCreation, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ArrayCreation__ArrayCreation = new ExecutorFragment(Types._ArrayCreation, JavaMMTables.Types._ArrayCreation);
		private static final /*@NonNull*/ ExecutorFragment _ArrayCreation__Expression = new ExecutorFragment(Types._ArrayCreation, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ArrayInitializer__ASTNode = new ExecutorFragment(Types._ArrayInitializer, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ArrayInitializer__ArrayInitializer = new ExecutorFragment(Types._ArrayInitializer, JavaMMTables.Types._ArrayInitializer);
		private static final /*@NonNull*/ ExecutorFragment _ArrayInitializer__Expression = new ExecutorFragment(Types._ArrayInitializer, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ArrayLengthAccess__ASTNode = new ExecutorFragment(Types._ArrayLengthAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ArrayLengthAccess__ArrayLengthAccess = new ExecutorFragment(Types._ArrayLengthAccess, JavaMMTables.Types._ArrayLengthAccess);
		private static final /*@NonNull*/ ExecutorFragment _ArrayLengthAccess__Expression = new ExecutorFragment(Types._ArrayLengthAccess, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ArrayType__ASTNode = new ExecutorFragment(Types._ArrayType, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ArrayType__ArrayType = new ExecutorFragment(Types._ArrayType, JavaMMTables.Types._ArrayType);
		private static final /*@NonNull*/ ExecutorFragment _ArrayType__NamedElement = new ExecutorFragment(Types._ArrayType, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ArrayType__Type = new ExecutorFragment(Types._ArrayType, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _AssertStatement__ASTNode = new ExecutorFragment(Types._AssertStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _AssertStatement__AssertStatement = new ExecutorFragment(Types._AssertStatement, JavaMMTables.Types._AssertStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _AssertStatement__Statement = new ExecutorFragment(Types._AssertStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _Assignment__ASTNode = new ExecutorFragment(Types._Assignment, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Assignment__Assignment = new ExecutorFragment(Types._Assignment, JavaMMTables.Types._Assignment);
		private static final /*@NonNull*/ ExecutorFragment _Assignment__Expression = new ExecutorFragment(Types._Assignment, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _AssignmentKind__AssignmentKind = new ExecutorFragment(Types._AssignmentKind, JavaMMTables.Types._AssignmentKind);
		...
		private static final /*@NonNull*/ ExecutorFragment _Block__ASTNode = new ExecutorFragment(Types._Block, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Block__Block = new ExecutorFragment(Types._Block, JavaMMTables.Types._Block);
		...
		private static final /*@NonNull*/ ExecutorFragment _Block__Statement = new ExecutorFragment(Types._Block, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _BlockComment__ASTNode = new ExecutorFragment(Types._BlockComment, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _BlockComment__BlockComment = new ExecutorFragment(Types._BlockComment, JavaMMTables.Types._BlockComment);
		private static final /*@NonNull*/ ExecutorFragment _BlockComment__Comment = new ExecutorFragment(Types._BlockComment, JavaMMTables.Types._Comment);
		...
		private static final /*@NonNull*/ ExecutorFragment _BodyDeclaration__ASTNode = new ExecutorFragment(Types._BodyDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _BodyDeclaration__BodyDeclaration = new ExecutorFragment(Types._BodyDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _BodyDeclaration__NamedElement = new ExecutorFragment(Types._BodyDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _BooleanLiteral__ASTNode = new ExecutorFragment(Types._BooleanLiteral, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _BooleanLiteral__BooleanLiteral = new ExecutorFragment(Types._BooleanLiteral, JavaMMTables.Types._BooleanLiteral);
		private static final /*@NonNull*/ ExecutorFragment _BooleanLiteral__Expression = new ExecutorFragment(Types._BooleanLiteral, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _BreakStatement__ASTNode = new ExecutorFragment(Types._BreakStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _BreakStatement__BreakStatement = new ExecutorFragment(Types._BreakStatement, JavaMMTables.Types._BreakStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _BreakStatement__Statement = new ExecutorFragment(Types._BreakStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _CastExpression__ASTNode = new ExecutorFragment(Types._CastExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _CastExpression__CastExpression = new ExecutorFragment(Types._CastExpression, JavaMMTables.Types._CastExpression);
		private static final /*@NonNull*/ ExecutorFragment _CastExpression__Expression = new ExecutorFragment(Types._CastExpression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _CatchClause__ASTNode = new ExecutorFragment(Types._CatchClause, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _CatchClause__CatchClause = new ExecutorFragment(Types._CatchClause, JavaMMTables.Types._CatchClause);
		...
		private static final /*@NonNull*/ ExecutorFragment _CatchClause__Statement = new ExecutorFragment(Types._CatchClause, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _CharacterLiteral__ASTNode = new ExecutorFragment(Types._CharacterLiteral, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _CharacterLiteral__CharacterLiteral = new ExecutorFragment(Types._CharacterLiteral, JavaMMTables.Types._CharacterLiteral);
		private static final /*@NonNull*/ ExecutorFragment _CharacterLiteral__Expression = new ExecutorFragment(Types._CharacterLiteral, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ClassDeclaration__ASTNode = new ExecutorFragment(Types._ClassDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ClassDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._ClassDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _ClassDeclaration__BodyDeclaration = new ExecutorFragment(Types._ClassDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _ClassDeclaration__ClassDeclaration = new ExecutorFragment(Types._ClassDeclaration, JavaMMTables.Types._ClassDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _ClassDeclaration__NamedElement = new ExecutorFragment(Types._ClassDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ClassDeclaration__Type = new ExecutorFragment(Types._ClassDeclaration, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _ClassDeclaration__TypeDeclaration = new ExecutorFragment(Types._ClassDeclaration, JavaMMTables.Types._TypeDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _ClassFile__ASTNode = new ExecutorFragment(Types._ClassFile, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ClassFile__ClassFile = new ExecutorFragment(Types._ClassFile, JavaMMTables.Types._ClassFile);
		private static final /*@NonNull*/ ExecutorFragment _ClassFile__NamedElement = new ExecutorFragment(Types._ClassFile, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ClassInstanceCreation__ASTNode = new ExecutorFragment(Types._ClassInstanceCreation, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ClassInstanceCreation__AbstractMethodInvocation = new ExecutorFragment(Types._ClassInstanceCreation, JavaMMTables.Types._AbstractMethodInvocation);
		private static final /*@NonNull*/ ExecutorFragment _ClassInstanceCreation__ClassInstanceCreation = new ExecutorFragment(Types._ClassInstanceCreation, JavaMMTables.Types._ClassInstanceCreation);
		private static final /*@NonNull*/ ExecutorFragment _ClassInstanceCreation__Expression = new ExecutorFragment(Types._ClassInstanceCreation, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _Comment__ASTNode = new ExecutorFragment(Types._Comment, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Comment__Comment = new ExecutorFragment(Types._Comment, JavaMMTables.Types._Comment);
		...
		private static final /*@NonNull*/ ExecutorFragment _CompilationUnit__ASTNode = new ExecutorFragment(Types._CompilationUnit, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _CompilationUnit__CompilationUnit = new ExecutorFragment(Types._CompilationUnit, JavaMMTables.Types._CompilationUnit);
		private static final /*@NonNull*/ ExecutorFragment _CompilationUnit__NamedElement = new ExecutorFragment(Types._CompilationUnit, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ConditionalExpression__ASTNode = new ExecutorFragment(Types._ConditionalExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ConditionalExpression__ConditionalExpression = new ExecutorFragment(Types._ConditionalExpression, JavaMMTables.Types._ConditionalExpression);
		private static final /*@NonNull*/ ExecutorFragment _ConditionalExpression__Expression = new ExecutorFragment(Types._ConditionalExpression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ConstructorDeclaration__ASTNode = new ExecutorFragment(Types._ConstructorDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ConstructorDeclaration__AbstractMethodDeclaration = new ExecutorFragment(Types._ConstructorDeclaration, JavaMMTables.Types._AbstractMethodDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _ConstructorDeclaration__BodyDeclaration = new ExecutorFragment(Types._ConstructorDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _ConstructorDeclaration__ConstructorDeclaration = new ExecutorFragment(Types._ConstructorDeclaration, JavaMMTables.Types._ConstructorDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _ConstructorDeclaration__NamedElement = new ExecutorFragment(Types._ConstructorDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ConstructorInvocation__ASTNode = new ExecutorFragment(Types._ConstructorInvocation, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ConstructorInvocation__AbstractMethodInvocation = new ExecutorFragment(Types._ConstructorInvocation, JavaMMTables.Types._AbstractMethodInvocation);
		private static final /*@NonNull*/ ExecutorFragment _ConstructorInvocation__ConstructorInvocation = new ExecutorFragment(Types._ConstructorInvocation, JavaMMTables.Types._ConstructorInvocation);
		...
		private static final /*@NonNull*/ ExecutorFragment _ConstructorInvocation__Statement = new ExecutorFragment(Types._ConstructorInvocation, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _ContinueStatement__ASTNode = new ExecutorFragment(Types._ContinueStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ContinueStatement__ContinueStatement = new ExecutorFragment(Types._ContinueStatement, JavaMMTables.Types._ContinueStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ContinueStatement__Statement = new ExecutorFragment(Types._ContinueStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _DoStatement__ASTNode = new ExecutorFragment(Types._DoStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _DoStatement__DoStatement = new ExecutorFragment(Types._DoStatement, JavaMMTables.Types._DoStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _DoStatement__Statement = new ExecutorFragment(Types._DoStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _EmptyStatement__ASTNode = new ExecutorFragment(Types._EmptyStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _EmptyStatement__EmptyStatement = new ExecutorFragment(Types._EmptyStatement, JavaMMTables.Types._EmptyStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _EmptyStatement__Statement = new ExecutorFragment(Types._EmptyStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _EnhancedForStatement__ASTNode = new ExecutorFragment(Types._EnhancedForStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _EnhancedForStatement__EnhancedForStatement = new ExecutorFragment(Types._EnhancedForStatement, JavaMMTables.Types._EnhancedForStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _EnhancedForStatement__Statement = new ExecutorFragment(Types._EnhancedForStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _EnumConstantDeclaration__ASTNode = new ExecutorFragment(Types._EnumConstantDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _EnumConstantDeclaration__BodyDeclaration = new ExecutorFragment(Types._EnumConstantDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _EnumConstantDeclaration__EnumConstantDeclaration = new ExecutorFragment(Types._EnumConstantDeclaration, JavaMMTables.Types._EnumConstantDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _EnumConstantDeclaration__NamedElement = new ExecutorFragment(Types._EnumConstantDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _EnumConstantDeclaration__VariableDeclaration = new ExecutorFragment(Types._EnumConstantDeclaration, JavaMMTables.Types._VariableDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _EnumDeclaration__ASTNode = new ExecutorFragment(Types._EnumDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _EnumDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._EnumDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _EnumDeclaration__BodyDeclaration = new ExecutorFragment(Types._EnumDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _EnumDeclaration__EnumDeclaration = new ExecutorFragment(Types._EnumDeclaration, JavaMMTables.Types._EnumDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _EnumDeclaration__NamedElement = new ExecutorFragment(Types._EnumDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _EnumDeclaration__Type = new ExecutorFragment(Types._EnumDeclaration, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _Expression__ASTNode = new ExecutorFragment(Types._Expression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Expression__Expression = new ExecutorFragment(Types._Expression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ExpressionStatement__ASTNode = new ExecutorFragment(Types._ExpressionStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ExpressionStatement__ExpressionStatement = new ExecutorFragment(Types._ExpressionStatement, JavaMMTables.Types._ExpressionStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ExpressionStatement__Statement = new ExecutorFragment(Types._ExpressionStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _FieldAccess__ASTNode = new ExecutorFragment(Types._FieldAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _FieldAccess__Expression = new ExecutorFragment(Types._FieldAccess, JavaMMTables.Types._Expression);
		private static final /*@NonNull*/ ExecutorFragment _FieldAccess__FieldAccess = new ExecutorFragment(Types._FieldAccess, JavaMMTables.Types._FieldAccess);
		...
		private static final /*@NonNull*/ ExecutorFragment _FieldDeclaration__ASTNode = new ExecutorFragment(Types._FieldDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _FieldDeclaration__AbstractVariablesContainer = new ExecutorFragment(Types._FieldDeclaration, JavaMMTables.Types._AbstractVariablesContainer);
		private static final /*@NonNull*/ ExecutorFragment _FieldDeclaration__BodyDeclaration = new ExecutorFragment(Types._FieldDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _FieldDeclaration__FieldDeclaration = new ExecutorFragment(Types._FieldDeclaration, JavaMMTables.Types._FieldDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _FieldDeclaration__NamedElement = new ExecutorFragment(Types._FieldDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ForStatement__ASTNode = new ExecutorFragment(Types._ForStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ForStatement__ForStatement = new ExecutorFragment(Types._ForStatement, JavaMMTables.Types._ForStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ForStatement__Statement = new ExecutorFragment(Types._ForStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _IfStatement__ASTNode = new ExecutorFragment(Types._IfStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _IfStatement__IfStatement = new ExecutorFragment(Types._IfStatement, JavaMMTables.Types._IfStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _IfStatement__Statement = new ExecutorFragment(Types._IfStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _ImportDeclaration__ASTNode = new ExecutorFragment(Types._ImportDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ImportDeclaration__ImportDeclaration = new ExecutorFragment(Types._ImportDeclaration, JavaMMTables.Types._ImportDeclaration);
		...
		private static final /*@NonNull*/ ExecutorFragment _InfixExpression__ASTNode = new ExecutorFragment(Types._InfixExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _InfixExpression__Expression = new ExecutorFragment(Types._InfixExpression, JavaMMTables.Types._Expression);
		private static final /*@NonNull*/ ExecutorFragment _InfixExpression__InfixExpression = new ExecutorFragment(Types._InfixExpression, JavaMMTables.Types._InfixExpression);
		...
		private static final /*@NonNull*/ ExecutorFragment _InfixExpressionKind__InfixExpressionKind = new ExecutorFragment(Types._InfixExpressionKind, JavaMMTables.Types._InfixExpressionKind);
		...
		private static final /*@NonNull*/ ExecutorFragment _InheritanceKind__InheritanceKind = new ExecutorFragment(Types._InheritanceKind, JavaMMTables.Types._InheritanceKind);
		...
		private static final /*@NonNull*/ ExecutorFragment _Initializer__ASTNode = new ExecutorFragment(Types._Initializer, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Initializer__BodyDeclaration = new ExecutorFragment(Types._Initializer, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _Initializer__Initializer = new ExecutorFragment(Types._Initializer, JavaMMTables.Types._Initializer);
		private static final /*@NonNull*/ ExecutorFragment _Initializer__NamedElement = new ExecutorFragment(Types._Initializer, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _InstanceofExpression__ASTNode = new ExecutorFragment(Types._InstanceofExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _InstanceofExpression__Expression = new ExecutorFragment(Types._InstanceofExpression, JavaMMTables.Types._Expression);
		private static final /*@NonNull*/ ExecutorFragment _InstanceofExpression__InstanceofExpression = new ExecutorFragment(Types._InstanceofExpression, JavaMMTables.Types._InstanceofExpression);
		...
		private static final /*@NonNull*/ ExecutorFragment _InterfaceDeclaration__ASTNode = new ExecutorFragment(Types._InterfaceDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _InterfaceDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._InterfaceDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _InterfaceDeclaration__BodyDeclaration = new ExecutorFragment(Types._InterfaceDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _InterfaceDeclaration__InterfaceDeclaration = new ExecutorFragment(Types._InterfaceDeclaration, JavaMMTables.Types._InterfaceDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _InterfaceDeclaration__NamedElement = new ExecutorFragment(Types._InterfaceDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _InterfaceDeclaration__Type = new ExecutorFragment(Types._InterfaceDeclaration, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _InterfaceDeclaration__TypeDeclaration = new ExecutorFragment(Types._InterfaceDeclaration, JavaMMTables.Types._TypeDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _Javadoc__ASTNode = new ExecutorFragment(Types._Javadoc, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Javadoc__Comment = new ExecutorFragment(Types._Javadoc, JavaMMTables.Types._Comment);
		private static final /*@NonNull*/ ExecutorFragment _Javadoc__Javadoc = new ExecutorFragment(Types._Javadoc, JavaMMTables.Types._Javadoc);
		...
		private static final /*@NonNull*/ ExecutorFragment _LabeledStatement__ASTNode = new ExecutorFragment(Types._LabeledStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _LabeledStatement__LabeledStatement = new ExecutorFragment(Types._LabeledStatement, JavaMMTables.Types._LabeledStatement);
		private static final /*@NonNull*/ ExecutorFragment _LabeledStatement__NamedElement = new ExecutorFragment(Types._LabeledStatement, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _LabeledStatement__Statement = new ExecutorFragment(Types._LabeledStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _LineComment__ASTNode = new ExecutorFragment(Types._LineComment, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _LineComment__Comment = new ExecutorFragment(Types._LineComment, JavaMMTables.Types._Comment);
		private static final /*@NonNull*/ ExecutorFragment _LineComment__LineComment = new ExecutorFragment(Types._LineComment, JavaMMTables.Types._LineComment);
		...
		private static final /*@NonNull*/ ExecutorFragment _Manifest__Manifest = new ExecutorFragment(Types._Manifest, JavaMMTables.Types._Manifest);
		...
		private static final /*@NonNull*/ ExecutorFragment _ManifestAttribute__ManifestAttribute = new ExecutorFragment(Types._ManifestAttribute, JavaMMTables.Types._ManifestAttribute);
		...
		private static final /*@NonNull*/ ExecutorFragment _ManifestEntry__ManifestEntry = new ExecutorFragment(Types._ManifestEntry, JavaMMTables.Types._ManifestEntry);
		...
		private static final /*@NonNull*/ ExecutorFragment _MemberRef__ASTNode = new ExecutorFragment(Types._MemberRef, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _MemberRef__MemberRef = new ExecutorFragment(Types._MemberRef, JavaMMTables.Types._MemberRef);
		...
		private static final /*@NonNull*/ ExecutorFragment _MethodDeclaration__ASTNode = new ExecutorFragment(Types._MethodDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _MethodDeclaration__AbstractMethodDeclaration = new ExecutorFragment(Types._MethodDeclaration, JavaMMTables.Types._AbstractMethodDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _MethodDeclaration__BodyDeclaration = new ExecutorFragment(Types._MethodDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _MethodDeclaration__MethodDeclaration = new ExecutorFragment(Types._MethodDeclaration, JavaMMTables.Types._MethodDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _MethodDeclaration__NamedElement = new ExecutorFragment(Types._MethodDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _MethodInvocation__ASTNode = new ExecutorFragment(Types._MethodInvocation, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _MethodInvocation__AbstractMethodInvocation = new ExecutorFragment(Types._MethodInvocation, JavaMMTables.Types._AbstractMethodInvocation);
		private static final /*@NonNull*/ ExecutorFragment _MethodInvocation__Expression = new ExecutorFragment(Types._MethodInvocation, JavaMMTables.Types._Expression);
		private static final /*@NonNull*/ ExecutorFragment _MethodInvocation__MethodInvocation = new ExecutorFragment(Types._MethodInvocation, JavaMMTables.Types._MethodInvocation);
		...
		private static final /*@NonNull*/ ExecutorFragment _MethodRef__ASTNode = new ExecutorFragment(Types._MethodRef, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _MethodRef__MethodRef = new ExecutorFragment(Types._MethodRef, JavaMMTables.Types._MethodRef);
		...
		private static final /*@NonNull*/ ExecutorFragment _MethodRefParameter__ASTNode = new ExecutorFragment(Types._MethodRefParameter, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _MethodRefParameter__MethodRefParameter = new ExecutorFragment(Types._MethodRefParameter, JavaMMTables.Types._MethodRefParameter);
		...
		private static final /*@NonNull*/ ExecutorFragment _Model__Model = new ExecutorFragment(Types._Model, JavaMMTables.Types._Model);
		...
		private static final /*@NonNull*/ ExecutorFragment _Modifier__ASTNode = new ExecutorFragment(Types._Modifier, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Modifier__Modifier = new ExecutorFragment(Types._Modifier, JavaMMTables.Types._Modifier);
		...
		private static final /*@NonNull*/ ExecutorFragment _NamedElement__ASTNode = new ExecutorFragment(Types._NamedElement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _NamedElement__NamedElement = new ExecutorFragment(Types._NamedElement, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _NamespaceAccess__ASTNode = new ExecutorFragment(Types._NamespaceAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _NamespaceAccess__NamespaceAccess = new ExecutorFragment(Types._NamespaceAccess, JavaMMTables.Types._NamespaceAccess);
		...
		private static final /*@NonNull*/ ExecutorFragment _NullLiteral__ASTNode = new ExecutorFragment(Types._NullLiteral, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _NullLiteral__Expression = new ExecutorFragment(Types._NullLiteral, JavaMMTables.Types._Expression);
		private static final /*@NonNull*/ ExecutorFragment _NullLiteral__NullLiteral = new ExecutorFragment(Types._NullLiteral, JavaMMTables.Types._NullLiteral);
		...
		private static final /*@NonNull*/ ExecutorFragment _NumberLiteral__ASTNode = new ExecutorFragment(Types._NumberLiteral, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _NumberLiteral__Expression = new ExecutorFragment(Types._NumberLiteral, JavaMMTables.Types._Expression);
		private static final /*@NonNull*/ ExecutorFragment _NumberLiteral__NumberLiteral = new ExecutorFragment(Types._NumberLiteral, JavaMMTables.Types._NumberLiteral);
		...
		private static final /*@NonNull*/ ExecutorFragment _Package__ASTNode = new ExecutorFragment(Types._Package, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Package__NamedElement = new ExecutorFragment(Types._Package, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _Package__Package = new ExecutorFragment(Types._Package, JavaMMTables.Types._Package);

		private static final /*@NonNull*/ ExecutorFragment _PackageAccess__ASTNode = new ExecutorFragment(Types._PackageAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PackageAccess__NamespaceAccess = new ExecutorFragment(Types._PackageAccess, JavaMMTables.Types._NamespaceAccess);
		...
		private static final /*@NonNull*/ ExecutorFragment _PackageAccess__PackageAccess = new ExecutorFragment(Types._PackageAccess, JavaMMTables.Types._PackageAccess);

		private static final /*@NonNull*/ ExecutorFragment _ParameterizedType__ASTNode = new ExecutorFragment(Types._ParameterizedType, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ParameterizedType__NamedElement = new ExecutorFragment(Types._ParameterizedType, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _ParameterizedType__ParameterizedType = new ExecutorFragment(Types._ParameterizedType, JavaMMTables.Types._ParameterizedType);
		private static final /*@NonNull*/ ExecutorFragment _ParameterizedType__Type = new ExecutorFragment(Types._ParameterizedType, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _ParenthesizedExpression__ASTNode = new ExecutorFragment(Types._ParenthesizedExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ParenthesizedExpression__Expression = new ExecutorFragment(Types._ParenthesizedExpression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ParenthesizedExpression__ParenthesizedExpression = new ExecutorFragment(Types._ParenthesizedExpression, JavaMMTables.Types._ParenthesizedExpression);

		private static final /*@NonNull*/ ExecutorFragment _PostfixExpression__ASTNode = new ExecutorFragment(Types._PostfixExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PostfixExpression__Expression = new ExecutorFragment(Types._PostfixExpression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _PostfixExpression__PostfixExpression = new ExecutorFragment(Types._PostfixExpression, JavaMMTables.Types._PostfixExpression);
		...
		private static final /*@NonNull*/ ExecutorFragment _PostfixExpressionKind__PostfixExpressionKind = new ExecutorFragment(Types._PostfixExpressionKind, JavaMMTables.Types._PostfixExpressionKind);

		private static final /*@NonNull*/ ExecutorFragment _PrefixExpression__ASTNode = new ExecutorFragment(Types._PrefixExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrefixExpression__Expression = new ExecutorFragment(Types._PrefixExpression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrefixExpression__PrefixExpression = new ExecutorFragment(Types._PrefixExpression, JavaMMTables.Types._PrefixExpression);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrefixExpressionKind__PrefixExpressionKind = new ExecutorFragment(Types._PrefixExpressionKind, JavaMMTables.Types._PrefixExpressionKind);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveType__ASTNode = new ExecutorFragment(Types._PrimitiveType, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveType__NamedElement = new ExecutorFragment(Types._PrimitiveType, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveType__PrimitiveType = new ExecutorFragment(Types._PrimitiveType, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveType__Type = new ExecutorFragment(Types._PrimitiveType, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeBoolean__ASTNode = new ExecutorFragment(Types._PrimitiveTypeBoolean, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeBoolean__NamedElement = new ExecutorFragment(Types._PrimitiveTypeBoolean, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeBoolean__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeBoolean, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeBoolean__PrimitiveTypeBoolean = new ExecutorFragment(Types._PrimitiveTypeBoolean, JavaMMTables.Types._PrimitiveTypeBoolean);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeBoolean__Type = new ExecutorFragment(Types._PrimitiveTypeBoolean, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeByte__ASTNode = new ExecutorFragment(Types._PrimitiveTypeByte, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeByte__NamedElement = new ExecutorFragment(Types._PrimitiveTypeByte, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeByte__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeByte, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeByte__PrimitiveTypeByte = new ExecutorFragment(Types._PrimitiveTypeByte, JavaMMTables.Types._PrimitiveTypeByte);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeByte__Type = new ExecutorFragment(Types._PrimitiveTypeByte, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeChar__ASTNode = new ExecutorFragment(Types._PrimitiveTypeChar, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeChar__NamedElement = new ExecutorFragment(Types._PrimitiveTypeChar, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeChar__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeChar, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeChar__PrimitiveTypeChar = new ExecutorFragment(Types._PrimitiveTypeChar, JavaMMTables.Types._PrimitiveTypeChar);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeChar__Type = new ExecutorFragment(Types._PrimitiveTypeChar, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeDouble__ASTNode = new ExecutorFragment(Types._PrimitiveTypeDouble, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeDouble__NamedElement = new ExecutorFragment(Types._PrimitiveTypeDouble, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeDouble__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeDouble, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeDouble__PrimitiveTypeDouble = new ExecutorFragment(Types._PrimitiveTypeDouble, JavaMMTables.Types._PrimitiveTypeDouble);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeDouble__Type = new ExecutorFragment(Types._PrimitiveTypeDouble, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeFloat__ASTNode = new ExecutorFragment(Types._PrimitiveTypeFloat, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeFloat__NamedElement = new ExecutorFragment(Types._PrimitiveTypeFloat, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeFloat__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeFloat, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeFloat__PrimitiveTypeFloat = new ExecutorFragment(Types._PrimitiveTypeFloat, JavaMMTables.Types._PrimitiveTypeFloat);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeFloat__Type = new ExecutorFragment(Types._PrimitiveTypeFloat, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeInt__ASTNode = new ExecutorFragment(Types._PrimitiveTypeInt, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeInt__NamedElement = new ExecutorFragment(Types._PrimitiveTypeInt, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeInt__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeInt, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeInt__PrimitiveTypeInt = new ExecutorFragment(Types._PrimitiveTypeInt, JavaMMTables.Types._PrimitiveTypeInt);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeInt__Type = new ExecutorFragment(Types._PrimitiveTypeInt, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeLong__ASTNode = new ExecutorFragment(Types._PrimitiveTypeLong, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeLong__NamedElement = new ExecutorFragment(Types._PrimitiveTypeLong, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeLong__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeLong, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeLong__PrimitiveTypeLong = new ExecutorFragment(Types._PrimitiveTypeLong, JavaMMTables.Types._PrimitiveTypeLong);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeLong__Type = new ExecutorFragment(Types._PrimitiveTypeLong, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeShort__ASTNode = new ExecutorFragment(Types._PrimitiveTypeShort, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeShort__NamedElement = new ExecutorFragment(Types._PrimitiveTypeShort, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeShort__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeShort, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeShort__PrimitiveTypeShort = new ExecutorFragment(Types._PrimitiveTypeShort, JavaMMTables.Types._PrimitiveTypeShort);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeShort__Type = new ExecutorFragment(Types._PrimitiveTypeShort, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeVoid__ASTNode = new ExecutorFragment(Types._PrimitiveTypeVoid, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeVoid__NamedElement = new ExecutorFragment(Types._PrimitiveTypeVoid, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeVoid__PrimitiveType = new ExecutorFragment(Types._PrimitiveTypeVoid, JavaMMTables.Types._PrimitiveType);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeVoid__PrimitiveTypeVoid = new ExecutorFragment(Types._PrimitiveTypeVoid, JavaMMTables.Types._PrimitiveTypeVoid);
		private static final /*@NonNull*/ ExecutorFragment _PrimitiveTypeVoid__Type = new ExecutorFragment(Types._PrimitiveTypeVoid, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _ReturnStatement__ASTNode = new ExecutorFragment(Types._ReturnStatement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _ReturnStatement__ReturnStatement = new ExecutorFragment(Types._ReturnStatement, JavaMMTables.Types._ReturnStatement);
		private static final /*@NonNull*/ ExecutorFragment _ReturnStatement__Statement = new ExecutorFragment(Types._ReturnStatement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _SingleVariableAccess__ASTNode = new ExecutorFragment(Types._SingleVariableAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _SingleVariableAccess__Expression = new ExecutorFragment(Types._SingleVariableAccess, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _SingleVariableAccess__SingleVariableAccess = new ExecutorFragment(Types._SingleVariableAccess, JavaMMTables.Types._SingleVariableAccess);

		private static final /*@NonNull*/ ExecutorFragment _SingleVariableDeclaration__ASTNode = new ExecutorFragment(Types._SingleVariableDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _SingleVariableDeclaration__NamedElement = new ExecutorFragment(Types._SingleVariableDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _SingleVariableDeclaration__SingleVariableDeclaration = new ExecutorFragment(Types._SingleVariableDeclaration, JavaMMTables.Types._SingleVariableDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _SingleVariableDeclaration__VariableDeclaration = new ExecutorFragment(Types._SingleVariableDeclaration, JavaMMTables.Types._VariableDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _Statement__ASTNode = new ExecutorFragment(Types._Statement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _Statement__Statement = new ExecutorFragment(Types._Statement, JavaMMTables.Types._Statement);

		private static final /*@NonNull*/ ExecutorFragment _StringLiteral__ASTNode = new ExecutorFragment(Types._StringLiteral, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _StringLiteral__Expression = new ExecutorFragment(Types._StringLiteral, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _StringLiteral__StringLiteral = new ExecutorFragment(Types._StringLiteral, JavaMMTables.Types._StringLiteral);

		private static final /*@NonNull*/ ExecutorFragment _SuperConstructorInvocation__ASTNode = new ExecutorFragment(Types._SuperConstructorInvocation, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _SuperConstructorInvocation__AbstractMethodInvocation = new ExecutorFragment(Types._SuperConstructorInvocation, JavaMMTables.Types._AbstractMethodInvocation);
		...
		private static final /*@NonNull*/ ExecutorFragment _SuperConstructorInvocation__Statement = new ExecutorFragment(Types._SuperConstructorInvocation, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _SuperConstructorInvocation__SuperConstructorInvocation = new ExecutorFragment(Types._SuperConstructorInvocation, JavaMMTables.Types._SuperConstructorInvocation);

		private static final /*@NonNull*/ ExecutorFragment _SuperFieldAccess__ASTNode = new ExecutorFragment(Types._SuperFieldAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _SuperFieldAccess__AbstractTypeQualifiedExpression = new ExecutorFragment(Types._SuperFieldAccess, JavaMMTables.Types._AbstractTypeQualifiedExpression);
		private static final /*@NonNull*/ ExecutorFragment _SuperFieldAccess__Expression = new ExecutorFragment(Types._SuperFieldAccess, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _SuperFieldAccess__SuperFieldAccess = new ExecutorFragment(Types._SuperFieldAccess, JavaMMTables.Types._SuperFieldAccess);

		private static final /*@NonNull*/ ExecutorFragment _SuperMethodInvocation__ASTNode = new ExecutorFragment(Types._SuperMethodInvocation, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _SuperMethodInvocation__AbstractMethodInvocation = new ExecutorFragment(Types._SuperMethodInvocation, JavaMMTables.Types._AbstractMethodInvocation);
		private static final /*@NonNull*/ ExecutorFragment _SuperMethodInvocation__AbstractTypeQualifiedExpression = new ExecutorFragment(Types._SuperMethodInvocation, JavaMMTables.Types._AbstractTypeQualifiedExpression);
		private static final /*@NonNull*/ ExecutorFragment _SuperMethodInvocation__Expression = new ExecutorFragment(Types._SuperMethodInvocation, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _SuperMethodInvocation__SuperMethodInvocation = new ExecutorFragment(Types._SuperMethodInvocation, JavaMMTables.Types._SuperMethodInvocation);

		private static final /*@NonNull*/ ExecutorFragment _SwitchCase__ASTNode = new ExecutorFragment(Types._SwitchCase, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _SwitchCase__Statement = new ExecutorFragment(Types._SwitchCase, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _SwitchCase__SwitchCase = new ExecutorFragment(Types._SwitchCase, JavaMMTables.Types._SwitchCase);

		private static final /*@NonNull*/ ExecutorFragment _SwitchStatement__ASTNode = new ExecutorFragment(Types._SwitchStatement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _SwitchStatement__Statement = new ExecutorFragment(Types._SwitchStatement, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _SwitchStatement__SwitchStatement = new ExecutorFragment(Types._SwitchStatement, JavaMMTables.Types._SwitchStatement);

		private static final /*@NonNull*/ ExecutorFragment _SynchronizedStatement__ASTNode = new ExecutorFragment(Types._SynchronizedStatement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _SynchronizedStatement__Statement = new ExecutorFragment(Types._SynchronizedStatement, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _SynchronizedStatement__SynchronizedStatement = new ExecutorFragment(Types._SynchronizedStatement, JavaMMTables.Types._SynchronizedStatement);

		private static final /*@NonNull*/ ExecutorFragment _TagElement__ASTNode = new ExecutorFragment(Types._TagElement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _TagElement__TagElement = new ExecutorFragment(Types._TagElement, JavaMMTables.Types._TagElement);

		private static final /*@NonNull*/ ExecutorFragment _TextElement__ASTNode = new ExecutorFragment(Types._TextElement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _TextElement__TextElement = new ExecutorFragment(Types._TextElement, JavaMMTables.Types._TextElement);

		private static final /*@NonNull*/ ExecutorFragment _ThisExpression__ASTNode = new ExecutorFragment(Types._ThisExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _ThisExpression__AbstractTypeQualifiedExpression = new ExecutorFragment(Types._ThisExpression, JavaMMTables.Types._AbstractTypeQualifiedExpression);
		private static final /*@NonNull*/ ExecutorFragment _ThisExpression__Expression = new ExecutorFragment(Types._ThisExpression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _ThisExpression__ThisExpression = new ExecutorFragment(Types._ThisExpression, JavaMMTables.Types._ThisExpression);

		private static final /*@NonNull*/ ExecutorFragment _ThrowStatement__ASTNode = new ExecutorFragment(Types._ThrowStatement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _ThrowStatement__Statement = new ExecutorFragment(Types._ThrowStatement, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _ThrowStatement__ThrowStatement = new ExecutorFragment(Types._ThrowStatement, JavaMMTables.Types._ThrowStatement);

		private static final /*@NonNull*/ ExecutorFragment _TryStatement__ASTNode = new ExecutorFragment(Types._TryStatement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _TryStatement__Statement = new ExecutorFragment(Types._TryStatement, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _TryStatement__TryStatement = new ExecutorFragment(Types._TryStatement, JavaMMTables.Types._TryStatement);

		private static final /*@NonNull*/ ExecutorFragment _Type__ASTNode = new ExecutorFragment(Types._Type, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _Type__NamedElement = new ExecutorFragment(Types._Type, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _Type__Type = new ExecutorFragment(Types._Type, JavaMMTables.Types._Type);

		private static final /*@NonNull*/ ExecutorFragment _TypeAccess__ASTNode = new ExecutorFragment(Types._TypeAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _TypeAccess__Expression = new ExecutorFragment(Types._TypeAccess, JavaMMTables.Types._Expression);
		private static final /*@NonNull*/ ExecutorFragment _TypeAccess__NamespaceAccess = new ExecutorFragment(Types._TypeAccess, JavaMMTables.Types._NamespaceAccess);
		...
		private static final /*@NonNull*/ ExecutorFragment _TypeAccess__TypeAccess = new ExecutorFragment(Types._TypeAccess, JavaMMTables.Types._TypeAccess);

		private static final /*@NonNull*/ ExecutorFragment _TypeDeclaration__ASTNode = new ExecutorFragment(Types._TypeDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _TypeDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._TypeDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _TypeDeclaration__BodyDeclaration = new ExecutorFragment(Types._TypeDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _TypeDeclaration__NamedElement = new ExecutorFragment(Types._TypeDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _TypeDeclaration__Type = new ExecutorFragment(Types._TypeDeclaration, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _TypeDeclaration__TypeDeclaration = new ExecutorFragment(Types._TypeDeclaration, JavaMMTables.Types._TypeDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _TypeDeclarationStatement__ASTNode = new ExecutorFragment(Types._TypeDeclarationStatement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _TypeDeclarationStatement__Statement = new ExecutorFragment(Types._TypeDeclarationStatement, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _TypeDeclarationStatement__TypeDeclarationStatement = new ExecutorFragment(Types._TypeDeclarationStatement, JavaMMTables.Types._TypeDeclarationStatement);

		private static final /*@NonNull*/ ExecutorFragment _TypeLiteral__ASTNode = new ExecutorFragment(Types._TypeLiteral, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _TypeLiteral__Expression = new ExecutorFragment(Types._TypeLiteral, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _TypeLiteral__TypeLiteral = new ExecutorFragment(Types._TypeLiteral, JavaMMTables.Types._TypeLiteral);

		private static final /*@NonNull*/ ExecutorFragment _TypeParameter__ASTNode = new ExecutorFragment(Types._TypeParameter, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _TypeParameter__NamedElement = new ExecutorFragment(Types._TypeParameter, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _TypeParameter__Type = new ExecutorFragment(Types._TypeParameter, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _TypeParameter__TypeParameter = new ExecutorFragment(Types._TypeParameter, JavaMMTables.Types._TypeParameter);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationDeclaration__ASTNode = new ExecutorFragment(Types._UnresolvedAnnotationDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._UnresolvedAnnotationDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationDeclaration__AnnotationTypeDeclaration = new ExecutorFragment(Types._UnresolvedAnnotationDeclaration, JavaMMTables.Types._AnnotationTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationDeclaration__BodyDeclaration = new ExecutorFragment(Types._UnresolvedAnnotationDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationDeclaration__NamedElement = new ExecutorFragment(Types._UnresolvedAnnotationDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationDeclaration__Type = new ExecutorFragment(Types._UnresolvedAnnotationDeclaration, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationDeclaration__UnresolvedAnnotationDeclaration = new ExecutorFragment(Types._UnresolvedAnnotationDeclaration, JavaMMTables.Types._UnresolvedAnnotationDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationDeclaration__UnresolvedItem = new ExecutorFragment(Types._UnresolvedAnnotationDeclaration, JavaMMTables.Types._UnresolvedItem);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationTypeMemberDeclaration__ASTNode = new ExecutorFragment(Types._UnresolvedAnnotationTypeMemberDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationTypeMemberDeclaration__AnnotationTypeMemberDeclaration = new ExecutorFragment(Types._UnresolvedAnnotationTypeMemberDeclaration, JavaMMTables.Types._AnnotationTypeMemberDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationTypeMemberDeclaration__BodyDeclaration = new ExecutorFragment(Types._UnresolvedAnnotationTypeMemberDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationTypeMemberDeclaration__NamedElement = new ExecutorFragment(Types._UnresolvedAnnotationTypeMemberDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationTypeMemberDeclaration__UnresolvedAnnotationTypeMemberDeclaration = new ExecutorFragment(Types._UnresolvedAnnotationTypeMemberDeclaration, JavaMMTables.Types._UnresolvedAnnotationTypeMemberDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedAnnotationTypeMemberDeclaration__UnresolvedItem = new ExecutorFragment(Types._UnresolvedAnnotationTypeMemberDeclaration, JavaMMTables.Types._UnresolvedItem);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__ASTNode = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__BodyDeclaration = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__ClassDeclaration = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._ClassDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__NamedElement = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__Type = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__TypeDeclaration = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._TypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__UnresolvedClassDeclaration = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._UnresolvedClassDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedClassDeclaration__UnresolvedItem = new ExecutorFragment(Types._UnresolvedClassDeclaration, JavaMMTables.Types._UnresolvedItem);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedEnumDeclaration__ASTNode = new ExecutorFragment(Types._UnresolvedEnumDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedEnumDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._UnresolvedEnumDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedEnumDeclaration__BodyDeclaration = new ExecutorFragment(Types._UnresolvedEnumDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedEnumDeclaration__EnumDeclaration = new ExecutorFragment(Types._UnresolvedEnumDeclaration, JavaMMTables.Types._EnumDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedEnumDeclaration__NamedElement = new ExecutorFragment(Types._UnresolvedEnumDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedEnumDeclaration__Type = new ExecutorFragment(Types._UnresolvedEnumDeclaration, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedEnumDeclaration__UnresolvedEnumDeclaration = new ExecutorFragment(Types._UnresolvedEnumDeclaration, JavaMMTables.Types._UnresolvedEnumDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedEnumDeclaration__UnresolvedItem = new ExecutorFragment(Types._UnresolvedEnumDeclaration, JavaMMTables.Types._UnresolvedItem);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__ASTNode = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__BodyDeclaration = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__InterfaceDeclaration = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._InterfaceDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__NamedElement = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__Type = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__TypeDeclaration = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._TypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__UnresolvedInterfaceDeclaration = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._UnresolvedInterfaceDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedInterfaceDeclaration__UnresolvedItem = new ExecutorFragment(Types._UnresolvedInterfaceDeclaration, JavaMMTables.Types._UnresolvedItem);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedItem__ASTNode = new ExecutorFragment(Types._UnresolvedItem, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedItem__NamedElement = new ExecutorFragment(Types._UnresolvedItem, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedItem__UnresolvedItem = new ExecutorFragment(Types._UnresolvedItem, JavaMMTables.Types._UnresolvedItem);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedItemAccess__ASTNode = new ExecutorFragment(Types._UnresolvedItemAccess, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedItemAccess__Expression = new ExecutorFragment(Types._UnresolvedItemAccess, JavaMMTables.Types._Expression);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedItemAccess__NamespaceAccess = new ExecutorFragment(Types._UnresolvedItemAccess, JavaMMTables.Types._NamespaceAccess);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedItemAccess__UnresolvedItemAccess = new ExecutorFragment(Types._UnresolvedItemAccess, JavaMMTables.Types._UnresolvedItemAccess);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedLabeledStatement__ASTNode = new ExecutorFragment(Types._UnresolvedLabeledStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedLabeledStatement__LabeledStatement = new ExecutorFragment(Types._UnresolvedLabeledStatement, JavaMMTables.Types._LabeledStatement);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedLabeledStatement__NamedElement = new ExecutorFragment(Types._UnresolvedLabeledStatement, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedLabeledStatement__Statement = new ExecutorFragment(Types._UnresolvedLabeledStatement, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedLabeledStatement__UnresolvedItem = new ExecutorFragment(Types._UnresolvedLabeledStatement, JavaMMTables.Types._UnresolvedItem);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedLabeledStatement__UnresolvedLabeledStatement = new ExecutorFragment(Types._UnresolvedLabeledStatement, JavaMMTables.Types._UnresolvedLabeledStatement);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedMethodDeclaration__ASTNode = new ExecutorFragment(Types._UnresolvedMethodDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedMethodDeclaration__AbstractMethodDeclaration = new ExecutorFragment(Types._UnresolvedMethodDeclaration, JavaMMTables.Types._AbstractMethodDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedMethodDeclaration__BodyDeclaration = new ExecutorFragment(Types._UnresolvedMethodDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedMethodDeclaration__MethodDeclaration = new ExecutorFragment(Types._UnresolvedMethodDeclaration, JavaMMTables.Types._MethodDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedMethodDeclaration__NamedElement = new ExecutorFragment(Types._UnresolvedMethodDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedMethodDeclaration__UnresolvedItem = new ExecutorFragment(Types._UnresolvedMethodDeclaration, JavaMMTables.Types._UnresolvedItem);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedMethodDeclaration__UnresolvedMethodDeclaration = new ExecutorFragment(Types._UnresolvedMethodDeclaration, JavaMMTables.Types._UnresolvedMethodDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedSingleVariableDeclaration__ASTNode = new ExecutorFragment(Types._UnresolvedSingleVariableDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedSingleVariableDeclaration__NamedElement = new ExecutorFragment(Types._UnresolvedSingleVariableDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedSingleVariableDeclaration__SingleVariableDeclaration = new ExecutorFragment(Types._UnresolvedSingleVariableDeclaration, JavaMMTables.Types._SingleVariableDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedSingleVariableDeclaration__UnresolvedItem = new ExecutorFragment(Types._UnresolvedSingleVariableDeclaration, JavaMMTables.Types._UnresolvedItem);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedSingleVariableDeclaration__UnresolvedSingleVariableDeclaration = new ExecutorFragment(Types._UnresolvedSingleVariableDeclaration, JavaMMTables.Types._UnresolvedSingleVariableDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedSingleVariableDeclaration__VariableDeclaration = new ExecutorFragment(Types._UnresolvedSingleVariableDeclaration, JavaMMTables.Types._VariableDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedType__ASTNode = new ExecutorFragment(Types._UnresolvedType, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedType__NamedElement = new ExecutorFragment(Types._UnresolvedType, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedType__Type = new ExecutorFragment(Types._UnresolvedType, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedType__UnresolvedItem = new ExecutorFragment(Types._UnresolvedType, JavaMMTables.Types._UnresolvedItem);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedType__UnresolvedType = new ExecutorFragment(Types._UnresolvedType, JavaMMTables.Types._UnresolvedType);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedTypeDeclaration__ASTNode = new ExecutorFragment(Types._UnresolvedTypeDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedTypeDeclaration__AbstractTypeDeclaration = new ExecutorFragment(Types._UnresolvedTypeDeclaration, JavaMMTables.Types._AbstractTypeDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedTypeDeclaration__BodyDeclaration = new ExecutorFragment(Types._UnresolvedTypeDeclaration, JavaMMTables.Types._BodyDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedTypeDeclaration__NamedElement = new ExecutorFragment(Types._UnresolvedTypeDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedTypeDeclaration__Type = new ExecutorFragment(Types._UnresolvedTypeDeclaration, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedTypeDeclaration__UnresolvedItem = new ExecutorFragment(Types._UnresolvedTypeDeclaration, JavaMMTables.Types._UnresolvedItem);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedTypeDeclaration__UnresolvedTypeDeclaration = new ExecutorFragment(Types._UnresolvedTypeDeclaration, JavaMMTables.Types._UnresolvedTypeDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _UnresolvedVariableDeclarationFragment__ASTNode = new ExecutorFragment(Types._UnresolvedVariableDeclarationFragment, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedVariableDeclarationFragment__NamedElement = new ExecutorFragment(Types._UnresolvedVariableDeclarationFragment, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedVariableDeclarationFragment__UnresolvedItem = new ExecutorFragment(Types._UnresolvedVariableDeclarationFragment, JavaMMTables.Types._UnresolvedItem);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedVariableDeclarationFragment__UnresolvedVariableDeclarationFragment = new ExecutorFragment(Types._UnresolvedVariableDeclarationFragment, JavaMMTables.Types._UnresolvedVariableDeclarationFragment);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedVariableDeclarationFragment__VariableDeclaration = new ExecutorFragment(Types._UnresolvedVariableDeclarationFragment, JavaMMTables.Types._VariableDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _UnresolvedVariableDeclarationFragment__VariableDeclarationFragment = new ExecutorFragment(Types._UnresolvedVariableDeclarationFragment, JavaMMTables.Types._VariableDeclarationFragment);

		private static final /*@NonNull*/ ExecutorFragment _VariableDeclaration__ASTNode = new ExecutorFragment(Types._VariableDeclaration, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclaration__NamedElement = new ExecutorFragment(Types._VariableDeclaration, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclaration__VariableDeclaration = new ExecutorFragment(Types._VariableDeclaration, JavaMMTables.Types._VariableDeclaration);

		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationExpression__ASTNode = new ExecutorFragment(Types._VariableDeclarationExpression, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationExpression__AbstractVariablesContainer = new ExecutorFragment(Types._VariableDeclarationExpression, JavaMMTables.Types._AbstractVariablesContainer);
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationExpression__Expression = new ExecutorFragment(Types._VariableDeclarationExpression, JavaMMTables.Types._Expression);
		...
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationExpression__VariableDeclarationExpression = new ExecutorFragment(Types._VariableDeclarationExpression, JavaMMTables.Types._VariableDeclarationExpression);

		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationFragment__ASTNode = new ExecutorFragment(Types._VariableDeclarationFragment, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationFragment__NamedElement = new ExecutorFragment(Types._VariableDeclarationFragment, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationFragment__VariableDeclaration = new ExecutorFragment(Types._VariableDeclarationFragment, JavaMMTables.Types._VariableDeclaration);
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationFragment__VariableDeclarationFragment = new ExecutorFragment(Types._VariableDeclarationFragment, JavaMMTables.Types._VariableDeclarationFragment);

		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationStatement__ASTNode = new ExecutorFragment(Types._VariableDeclarationStatement, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationStatement__AbstractVariablesContainer = new ExecutorFragment(Types._VariableDeclarationStatement, JavaMMTables.Types._AbstractVariablesContainer);
		...
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationStatement__Statement = new ExecutorFragment(Types._VariableDeclarationStatement, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _VariableDeclarationStatement__VariableDeclarationStatement = new ExecutorFragment(Types._VariableDeclarationStatement, JavaMMTables.Types._VariableDeclarationStatement);
		...
		private static final /*@NonNull*/ ExecutorFragment _VisibilityKind__VisibilityKind = new ExecutorFragment(Types._VisibilityKind, JavaMMTables.Types._VisibilityKind);

		private static final /*@NonNull*/ ExecutorFragment _WhileStatement__ASTNode = new ExecutorFragment(Types._WhileStatement, JavaMMTables.Types._ASTNode);
		...
		private static final /*@NonNull*/ ExecutorFragment _WhileStatement__Statement = new ExecutorFragment(Types._WhileStatement, JavaMMTables.Types._Statement);
		private static final /*@NonNull*/ ExecutorFragment _WhileStatement__WhileStatement = new ExecutorFragment(Types._WhileStatement, JavaMMTables.Types._WhileStatement);

		private static final /*@NonNull*/ ExecutorFragment _WildCardType__ASTNode = new ExecutorFragment(Types._WildCardType, JavaMMTables.Types._ASTNode);
		private static final /*@NonNull*/ ExecutorFragment _WildCardType__NamedElement = new ExecutorFragment(Types._WildCardType, JavaMMTables.Types._NamedElement);
		...
		private static final /*@NonNull*/ ExecutorFragment _WildCardType__Type = new ExecutorFragment(Types._WildCardType, JavaMMTables.Types._Type);
		private static final /*@NonNull*/ ExecutorFragment _WildCardType__WildCardType = new ExecutorFragment(Types._WildCardType, JavaMMTables.Types._WildCardType);
		...
		/**
		 * Force initialization of the fields of JavaMMTables::Fragments and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Parameters {
		...
		/**
		 * Force initialization of the fields of JavaMMTables::Parameters and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Operations {
		...
		public static final /*@NonNull*/ ExecutorOperation _AbstractTypeDeclaration__implements = new ExecutorOperation("implements", Parameters._String, Types._AbstractTypeDeclaration,
			0, TemplateParameters.EMPTY_LIST, null);

		public static final /*@NonNull*/ ExecutorOperation _ClassDeclaration__getMethods = new ExecutorOperation("getMethods", TypeUtil.EMPTY_PARAMETER_TYPES, Types._ClassDeclaration,
			0, TemplateParameters.EMPTY_LIST, null);
		public static final /*@NonNull*/ ExecutorOperation _ClassDeclaration__hasCompareTo = new ExecutorOperation("hasCompareTo", TypeUtil.EMPTY_PARAMETER_TYPES, Types._ClassDeclaration,
			1, TemplateParameters.EMPTY_LIST, null);
		public static final /*@NonNull*/ ExecutorOperation _ClassDeclaration__hasEquals = new ExecutorOperation("hasEquals", TypeUtil.EMPTY_PARAMETER_TYPES, Types._ClassDeclaration,
			2, TemplateParameters.EMPTY_LIST, null);
		public static final /*@NonNull*/ ExecutorOperation _ClassDeclaration__hasHashcode = new ExecutorOperation("hasHashcode", TypeUtil.EMPTY_PARAMETER_TYPES, Types._ClassDeclaration,
			3, TemplateParameters.EMPTY_LIST, null);

		public static final /*@NonNull*/ ExecutorOperation _InfixExpression__operatorIsEquality = new ExecutorOperation("operatorIsEquality", TypeUtil.EMPTY_PARAMETER_TYPES, Types._InfixExpression,
			0, TemplateParameters.EMPTY_LIST, null);

		public static final /*@NonNull*/ ExecutorOperation _Modifier__isLocal = new ExecutorOperation("isLocal", TypeUtil.EMPTY_PARAMETER_TYPES, Types._Modifier,
			0, TemplateParameters.EMPTY_LIST, null);
		...
		/**
		 * Force initialization of the fields of JavaMMTables::Operations and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Properties {
		...
		public static final /*@NonNull*/ ExecutorProperty _ASTNode__comments = new EcoreExecutorProperty(JavaMMPackage.Literals.AST_NODE__COMMENTS, Types._ASTNode, 0);
		public static final /*@NonNull*/ ExecutorProperty _ASTNode__originalClassFile = new EcoreExecutorProperty(JavaMMPackage.Literals.AST_NODE__ORIGINAL_CLASS_FILE, Types._ASTNode, 1);
		public static final /*@NonNull*/ ExecutorProperty _ASTNode__originalCompilationUnit = new EcoreExecutorProperty(JavaMMPackage.Literals.AST_NODE__ORIGINAL_COMPILATION_UNIT, Types._ASTNode, 2);
		public static final /*@NonNull*/ ExecutorProperty _ASTNode__TagElement__fragments = new ExecutorPropertyWithImplementation("TagElement", Types._ASTNode, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TAG_ELEMENT__FRAGMENTS));
		public static final /*@NonNull*/ ExecutorProperty _ASTNode__UnresolvedItemAccess__qualifier = new ExecutorPropertyWithImplementation("UnresolvedItemAccess", Types._ASTNode, 4, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.UNRESOLVED_ITEM_ACCESS__QUALIFIER));

		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodDeclaration__body = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__BODY, Types._AbstractMethodDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodDeclaration__parameters = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__PARAMETERS, Types._AbstractMethodDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodDeclaration__thrownExceptions = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__THROWN_EXCEPTIONS, Types._AbstractMethodDeclaration, 2);
		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodDeclaration__typeParameters = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__TYPE_PARAMETERS, Types._AbstractMethodDeclaration, 3);
		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodDeclaration__usages = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__USAGES, Types._AbstractMethodDeclaration, 4);
		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodDeclaration__usagesInDocComments = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__USAGES_IN_DOC_COMMENTS, Types._AbstractMethodDeclaration, 5);

		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodInvocation__arguments = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_INVOCATION__ARGUMENTS, Types._AbstractMethodInvocation, 0);
		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodInvocation__method = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_INVOCATION__METHOD, Types._AbstractMethodInvocation, 1);
		public static final /*@NonNull*/ ExecutorProperty _AbstractMethodInvocation__typeArguments = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_INVOCATION__TYPE_ARGUMENTS, Types._AbstractMethodInvocation, 2);

		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeDeclaration__bodyDeclarations = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION__BODY_DECLARATIONS, Types._AbstractTypeDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeDeclaration__commentsAfterBody = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION__COMMENTS_AFTER_BODY, Types._AbstractTypeDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeDeclaration__commentsBeforeBody = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION__COMMENTS_BEFORE_BODY, Types._AbstractTypeDeclaration, 2);
		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeDeclaration__package = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION__PACKAGE, Types._AbstractTypeDeclaration, 3);
		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeDeclaration__superInterfaces = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION__SUPER_INTERFACES, Types._AbstractTypeDeclaration, 4);
		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeDeclaration__ClassFile__type = new ExecutorPropertyWithImplementation("ClassFile", Types._AbstractTypeDeclaration, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CLASS_FILE__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeDeclaration__CompilationUnit__types = new ExecutorPropertyWithImplementation("CompilationUnit", Types._AbstractTypeDeclaration, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.COMPILATION_UNIT__TYPES));
		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeDeclaration__TypeDeclarationStatement__declaration = new ExecutorPropertyWithImplementation("TypeDeclarationStatement", Types._AbstractTypeDeclaration, 7, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TYPE_DECLARATION_STATEMENT__DECLARATION));

		public static final /*@NonNull*/ ExecutorProperty _AbstractTypeQualifiedExpression__qualifier = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_QUALIFIED_EXPRESSION__QUALIFIER, Types._AbstractTypeQualifiedExpression, 0);

		public static final /*@NonNull*/ ExecutorProperty _AbstractVariablesContainer__fragments = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_VARIABLES_CONTAINER__FRAGMENTS, Types._AbstractVariablesContainer, 0);
		public static final /*@NonNull*/ ExecutorProperty _AbstractVariablesContainer__type = new EcoreExecutorProperty(JavaMMPackage.Literals.ABSTRACT_VARIABLES_CONTAINER__TYPE, Types._AbstractVariablesContainer, 1);

		public static final /*@NonNull*/ ExecutorProperty _Annotation__type = new EcoreExecutorProperty(JavaMMPackage.Literals.ANNOTATION__TYPE, Types._Annotation, 0);
		public static final /*@NonNull*/ ExecutorProperty _Annotation__values = new EcoreExecutorProperty(JavaMMPackage.Literals.ANNOTATION__VALUES, Types._Annotation, 1);
		public static final /*@NonNull*/ ExecutorProperty _Annotation__BodyDeclaration__annotations = new ExecutorPropertyWithImplementation("BodyDeclaration", Types._Annotation, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.BODY_DECLARATION__ANNOTATIONS));
		public static final /*@NonNull*/ ExecutorProperty _Annotation__SingleVariableDeclaration__annotations = new ExecutorPropertyWithImplementation("SingleVariableDeclaration", Types._Annotation, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__ANNOTATIONS));
		public static final /*@NonNull*/ ExecutorProperty _Annotation__VariableDeclarationExpression__annotations = new ExecutorPropertyWithImplementation("VariableDeclarationExpression", Types._Annotation, 4, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION_EXPRESSION__ANNOTATIONS));
		public static final /*@NonNull*/ ExecutorProperty _Annotation__VariableDeclarationStatement__annotations = new ExecutorPropertyWithImplementation("VariableDeclarationStatement", Types._Annotation, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION_STATEMENT__ANNOTATIONS));

		public static final /*@NonNull*/ ExecutorProperty _AnnotationMemberValuePair__member = new EcoreExecutorProperty(JavaMMPackage.Literals.ANNOTATION_MEMBER_VALUE_PAIR__MEMBER, Types._AnnotationMemberValuePair, 0);
		public static final /*@NonNull*/ ExecutorProperty _AnnotationMemberValuePair__value = new EcoreExecutorProperty(JavaMMPackage.Literals.ANNOTATION_MEMBER_VALUE_PAIR__VALUE, Types._AnnotationMemberValuePair, 1);
		public static final /*@NonNull*/ ExecutorProperty _AnnotationMemberValuePair__Annotation__values = new ExecutorPropertyWithImplementation("Annotation", Types._AnnotationMemberValuePair, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ANNOTATION__VALUES));

		public static final /*@NonNull*/ ExecutorProperty _AnnotationTypeMemberDeclaration__default = new EcoreExecutorProperty(JavaMMPackage.Literals.ANNOTATION_TYPE_MEMBER_DECLARATION__DEFAULT, Types._AnnotationTypeMemberDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _AnnotationTypeMemberDeclaration__type = new EcoreExecutorProperty(JavaMMPackage.Literals.ANNOTATION_TYPE_MEMBER_DECLARATION__TYPE, Types._AnnotationTypeMemberDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _AnnotationTypeMemberDeclaration__usages = new EcoreExecutorProperty(JavaMMPackage.Literals.ANNOTATION_TYPE_MEMBER_DECLARATION__USAGES, Types._AnnotationTypeMemberDeclaration, 2);

		public static final /*@NonNull*/ ExecutorProperty _AnonymousClassDeclaration__bodyDeclarations = new EcoreExecutorProperty(JavaMMPackage.Literals.ANONYMOUS_CLASS_DECLARATION__BODY_DECLARATIONS, Types._AnonymousClassDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _AnonymousClassDeclaration__classInstanceCreation = new EcoreExecutorProperty(JavaMMPackage.Literals.ANONYMOUS_CLASS_DECLARATION__CLASS_INSTANCE_CREATION, Types._AnonymousClassDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _AnonymousClassDeclaration__EnumConstantDeclaration__anonymousClassDeclaration = new ExecutorPropertyWithImplementation("EnumConstantDeclaration", Types._AnonymousClassDeclaration, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION));

		public static final /*@NonNull*/ ExecutorProperty _Archive__classFiles = new EcoreExecutorProperty(JavaMMPackage.Literals.ARCHIVE__CLASS_FILES, Types._Archive, 0);
		public static final /*@NonNull*/ ExecutorProperty _Archive__manifest = new EcoreExecutorProperty(JavaMMPackage.Literals.ARCHIVE__MANIFEST, Types._Archive, 1);
		public static final /*@NonNull*/ ExecutorProperty _Archive__originalFilePath = new EcoreExecutorProperty(JavaMMPackage.Literals.ARCHIVE__ORIGINAL_FILE_PATH, Types._Archive, 2);
		public static final /*@NonNull*/ ExecutorProperty _Archive__Model__archives = new ExecutorPropertyWithImplementation("Model", Types._Archive, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MODEL__ARCHIVES));

		public static final /*@NonNull*/ ExecutorProperty _ArrayAccess__array = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_ACCESS__ARRAY, Types._ArrayAccess, 0);
		public static final /*@NonNull*/ ExecutorProperty _ArrayAccess__index = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_ACCESS__INDEX, Types._ArrayAccess, 1);

		public static final /*@NonNull*/ ExecutorProperty _ArrayCreation__dimensions = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_CREATION__DIMENSIONS, Types._ArrayCreation, 0);
		public static final /*@NonNull*/ ExecutorProperty _ArrayCreation__initializer = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_CREATION__INITIALIZER, Types._ArrayCreation, 1);
		public static final /*@NonNull*/ ExecutorProperty _ArrayCreation__type = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_CREATION__TYPE, Types._ArrayCreation, 2);

		public static final /*@NonNull*/ ExecutorProperty _ArrayInitializer__expressions = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_INITIALIZER__EXPRESSIONS, Types._ArrayInitializer, 0);
		public static final /*@NonNull*/ ExecutorProperty _ArrayInitializer__ArrayCreation__initializer = new ExecutorPropertyWithImplementation("ArrayCreation", Types._ArrayInitializer, 1, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARRAY_CREATION__INITIALIZER));

		public static final /*@NonNull*/ ExecutorProperty _ArrayLengthAccess__array = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_LENGTH_ACCESS__ARRAY, Types._ArrayLengthAccess, 0);

		public static final /*@NonNull*/ ExecutorProperty _ArrayType__dimensions = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_TYPE__DIMENSIONS, Types._ArrayType, 0);
		public static final /*@NonNull*/ ExecutorProperty _ArrayType__elementType = new EcoreExecutorProperty(JavaMMPackage.Literals.ARRAY_TYPE__ELEMENT_TYPE, Types._ArrayType, 1);

		public static final /*@NonNull*/ ExecutorProperty _AssertStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.ASSERT_STATEMENT__EXPRESSION, Types._AssertStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _AssertStatement__message = new EcoreExecutorProperty(JavaMMPackage.Literals.ASSERT_STATEMENT__MESSAGE, Types._AssertStatement, 1);

		public static final /*@NonNull*/ ExecutorProperty _Assignment__leftHandSide = new EcoreExecutorProperty(JavaMMPackage.Literals.ASSIGNMENT__LEFT_HAND_SIDE, Types._Assignment, 0);
		public static final /*@NonNull*/ ExecutorProperty _Assignment__operator = new EcoreExecutorProperty(JavaMMPackage.Literals.ASSIGNMENT__OPERATOR, Types._Assignment, 1);
		public static final /*@NonNull*/ ExecutorProperty _Assignment__rightHandSide = new EcoreExecutorProperty(JavaMMPackage.Literals.ASSIGNMENT__RIGHT_HAND_SIDE, Types._Assignment, 2);

		public static final /*@NonNull*/ ExecutorProperty _Block__statements = new EcoreExecutorProperty(JavaMMPackage.Literals.BLOCK__STATEMENTS, Types._Block, 0);
		public static final /*@NonNull*/ ExecutorProperty _Block__AbstractMethodDeclaration__body = new ExecutorPropertyWithImplementation("AbstractMethodDeclaration", Types._Block, 1, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Block__CatchClause__body = new ExecutorPropertyWithImplementation("CatchClause", Types._Block, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CATCH_CLAUSE__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Block__Initializer__body = new ExecutorPropertyWithImplementation("Initializer", Types._Block, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.INITIALIZER__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Block__SynchronizedStatement__body = new ExecutorPropertyWithImplementation("SynchronizedStatement", Types._Block, 4, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SYNCHRONIZED_STATEMENT__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Block__TryStatement__body = new ExecutorPropertyWithImplementation("TryStatement", Types._Block, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TRY_STATEMENT__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Block__TryStatement__finally = new ExecutorPropertyWithImplementation("TryStatement", Types._Block, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TRY_STATEMENT__FINALLY));

		public static final /*@NonNull*/ ExecutorProperty _BodyDeclaration__abstractTypeDeclaration = new EcoreExecutorProperty(JavaMMPackage.Literals.BODY_DECLARATION__ABSTRACT_TYPE_DECLARATION, Types._BodyDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _BodyDeclaration__annotations = new EcoreExecutorProperty(JavaMMPackage.Literals.BODY_DECLARATION__ANNOTATIONS, Types._BodyDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _BodyDeclaration__anonymousClassDeclarationOwner = new EcoreExecutorProperty(JavaMMPackage.Literals.BODY_DECLARATION__ANONYMOUS_CLASS_DECLARATION_OWNER, Types._BodyDeclaration, 2);
		public static final /*@NonNull*/ ExecutorProperty _BodyDeclaration__modifier = new EcoreExecutorProperty(JavaMMPackage.Literals.BODY_DECLARATION__MODIFIER, Types._BodyDeclaration, 3);

		public static final /*@NonNull*/ ExecutorProperty _BooleanLiteral__value = new EcoreExecutorProperty(JavaMMPackage.Literals.BOOLEAN_LITERAL__VALUE, Types._BooleanLiteral, 0);

		public static final /*@NonNull*/ ExecutorProperty _BreakStatement__label = new EcoreExecutorProperty(JavaMMPackage.Literals.BREAK_STATEMENT__LABEL, Types._BreakStatement, 0);

		public static final /*@NonNull*/ ExecutorProperty _CastExpression__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.CAST_EXPRESSION__EXPRESSION, Types._CastExpression, 0);
		public static final /*@NonNull*/ ExecutorProperty _CastExpression__type = new EcoreExecutorProperty(JavaMMPackage.Literals.CAST_EXPRESSION__TYPE, Types._CastExpression, 1);

		public static final /*@NonNull*/ ExecutorProperty _CatchClause__body = new EcoreExecutorProperty(JavaMMPackage.Literals.CATCH_CLAUSE__BODY, Types._CatchClause, 0);
		public static final /*@NonNull*/ ExecutorProperty _CatchClause__exception = new EcoreExecutorProperty(JavaMMPackage.Literals.CATCH_CLAUSE__EXCEPTION, Types._CatchClause, 1);
		public static final /*@NonNull*/ ExecutorProperty _CatchClause__TryStatement__catchClauses = new ExecutorPropertyWithImplementation("TryStatement", Types._CatchClause, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TRY_STATEMENT__CATCH_CLAUSES));

		public static final /*@NonNull*/ ExecutorProperty _CharacterLiteral__escapedValue = new EcoreExecutorProperty(JavaMMPackage.Literals.CHARACTER_LITERAL__ESCAPED_VALUE, Types._CharacterLiteral, 0);

		public static final /*@NonNull*/ ExecutorProperty _ClassDeclaration__superClass = new EcoreExecutorProperty(JavaMMPackage.Literals.CLASS_DECLARATION__SUPER_CLASS, Types._ClassDeclaration, 0);

		public static final /*@NonNull*/ ExecutorProperty _ClassFile__attachedSource = new EcoreExecutorProperty(JavaMMPackage.Literals.CLASS_FILE__ATTACHED_SOURCE, Types._ClassFile, 0);
		public static final /*@NonNull*/ ExecutorProperty _ClassFile__originalFilePath = new EcoreExecutorProperty(JavaMMPackage.Literals.CLASS_FILE__ORIGINAL_FILE_PATH, Types._ClassFile, 1);
		public static final /*@NonNull*/ ExecutorProperty _ClassFile__package = new EcoreExecutorProperty(JavaMMPackage.Literals.CLASS_FILE__PACKAGE, Types._ClassFile, 2);
		public static final /*@NonNull*/ ExecutorProperty _ClassFile__type = new EcoreExecutorProperty(JavaMMPackage.Literals.CLASS_FILE__TYPE, Types._ClassFile, 3);
		public static final /*@NonNull*/ ExecutorProperty _ClassFile__ASTNode__originalClassFile = new ExecutorPropertyWithImplementation("ASTNode", Types._ClassFile, 4, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.AST_NODE__ORIGINAL_CLASS_FILE));
		public static final /*@NonNull*/ ExecutorProperty _ClassFile__Archive__classFiles = new ExecutorPropertyWithImplementation("Archive", Types._ClassFile, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARCHIVE__CLASS_FILES));
		public static final /*@NonNull*/ ExecutorProperty _ClassFile__Model__classFiles = new ExecutorPropertyWithImplementation("Model", Types._ClassFile, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MODEL__CLASS_FILES));

		public static final /*@NonNull*/ ExecutorProperty _ClassInstanceCreation__anonymousClassDeclaration = new EcoreExecutorProperty(JavaMMPackage.Literals.CLASS_INSTANCE_CREATION__ANONYMOUS_CLASS_DECLARATION, Types._ClassInstanceCreation, 0);
		public static final /*@NonNull*/ ExecutorProperty _ClassInstanceCreation__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.CLASS_INSTANCE_CREATION__EXPRESSION, Types._ClassInstanceCreation, 1);
		public static final /*@NonNull*/ ExecutorProperty _ClassInstanceCreation__type = new EcoreExecutorProperty(JavaMMPackage.Literals.CLASS_INSTANCE_CREATION__TYPE, Types._ClassInstanceCreation, 2);

		public static final /*@NonNull*/ ExecutorProperty _Comment__content = new EcoreExecutorProperty(JavaMMPackage.Literals.COMMENT__CONTENT, Types._Comment, 0);
		public static final /*@NonNull*/ ExecutorProperty _Comment__enclosedByParent = new EcoreExecutorProperty(JavaMMPackage.Literals.COMMENT__ENCLOSED_BY_PARENT, Types._Comment, 1);
		public static final /*@NonNull*/ ExecutorProperty _Comment__prefixOfParent = new EcoreExecutorProperty(JavaMMPackage.Literals.COMMENT__PREFIX_OF_PARENT, Types._Comment, 2);
		public static final /*@NonNull*/ ExecutorProperty _Comment__ASTNode__comments = new ExecutorPropertyWithImplementation("ASTNode", Types._Comment, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.AST_NODE__COMMENTS));
		public static final /*@NonNull*/ ExecutorProperty _Comment__AbstractTypeDeclaration__commentsAfterBody = new ExecutorPropertyWithImplementation("AbstractTypeDeclaration", Types._Comment, 4, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION__COMMENTS_AFTER_BODY));
		public static final /*@NonNull*/ ExecutorProperty _Comment__AbstractTypeDeclaration__commentsBeforeBody = new ExecutorPropertyWithImplementation("AbstractTypeDeclaration", Types._Comment, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION__COMMENTS_BEFORE_BODY));
		public static final /*@NonNull*/ ExecutorProperty _Comment__CompilationUnit__commentList = new ExecutorPropertyWithImplementation("CompilationUnit", Types._Comment, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.COMPILATION_UNIT__COMMENT_LIST));

		public static final /*@NonNull*/ ExecutorProperty _CompilationUnit__commentList = new EcoreExecutorProperty(JavaMMPackage.Literals.COMPILATION_UNIT__COMMENT_LIST, Types._CompilationUnit, 0);
		public static final /*@NonNull*/ ExecutorProperty _CompilationUnit__imports = new EcoreExecutorProperty(JavaMMPackage.Literals.COMPILATION_UNIT__IMPORTS, Types._CompilationUnit, 1);
		public static final /*@NonNull*/ ExecutorProperty _CompilationUnit__originalFilePath = new EcoreExecutorProperty(JavaMMPackage.Literals.COMPILATION_UNIT__ORIGINAL_FILE_PATH, Types._CompilationUnit, 2);
		public static final /*@NonNull*/ ExecutorProperty _CompilationUnit__package = new EcoreExecutorProperty(JavaMMPackage.Literals.COMPILATION_UNIT__PACKAGE, Types._CompilationUnit, 3);
		public static final /*@NonNull*/ ExecutorProperty _CompilationUnit__types = new EcoreExecutorProperty(JavaMMPackage.Literals.COMPILATION_UNIT__TYPES, Types._CompilationUnit, 4);
		public static final /*@NonNull*/ ExecutorProperty _CompilationUnit__ASTNode__originalCompilationUnit = new ExecutorPropertyWithImplementation("ASTNode", Types._CompilationUnit, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.AST_NODE__ORIGINAL_COMPILATION_UNIT));
		public static final /*@NonNull*/ ExecutorProperty _CompilationUnit__ClassFile__attachedSource = new ExecutorPropertyWithImplementation("ClassFile", Types._CompilationUnit, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CLASS_FILE__ATTACHED_SOURCE));
		public static final /*@NonNull*/ ExecutorProperty _CompilationUnit__Model__compilationUnits = new ExecutorPropertyWithImplementation("Model", Types._CompilationUnit, 7, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MODEL__COMPILATION_UNITS));

		public static final /*@NonNull*/ ExecutorProperty _ConditionalExpression__elseExpression = new EcoreExecutorProperty(JavaMMPackage.Literals.CONDITIONAL_EXPRESSION__ELSE_EXPRESSION, Types._ConditionalExpression, 0);
		public static final /*@NonNull*/ ExecutorProperty _ConditionalExpression__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.CONDITIONAL_EXPRESSION__EXPRESSION, Types._ConditionalExpression, 1);
		public static final /*@NonNull*/ ExecutorProperty _ConditionalExpression__thenExpression = new EcoreExecutorProperty(JavaMMPackage.Literals.CONDITIONAL_EXPRESSION__THEN_EXPRESSION, Types._ConditionalExpression, 2);

		public static final /*@NonNull*/ ExecutorProperty _ContinueStatement__label = new EcoreExecutorProperty(JavaMMPackage.Literals.CONTINUE_STATEMENT__LABEL, Types._ContinueStatement, 0);

		public static final /*@NonNull*/ ExecutorProperty _DoStatement__body = new EcoreExecutorProperty(JavaMMPackage.Literals.DO_STATEMENT__BODY, Types._DoStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _DoStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.DO_STATEMENT__EXPRESSION, Types._DoStatement, 1);

		public static final /*@NonNull*/ ExecutorProperty _EnhancedForStatement__body = new EcoreExecutorProperty(JavaMMPackage.Literals.ENHANCED_FOR_STATEMENT__BODY, Types._EnhancedForStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _EnhancedForStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.ENHANCED_FOR_STATEMENT__EXPRESSION, Types._EnhancedForStatement, 1);
		public static final /*@NonNull*/ ExecutorProperty _EnhancedForStatement__parameter = new EcoreExecutorProperty(JavaMMPackage.Literals.ENHANCED_FOR_STATEMENT__PARAMETER, Types._EnhancedForStatement, 2);

		public static final /*@NonNull*/ ExecutorProperty _EnumConstantDeclaration__anonymousClassDeclaration = new EcoreExecutorProperty(JavaMMPackage.Literals.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION, Types._EnumConstantDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _EnumConstantDeclaration__arguments = new EcoreExecutorProperty(JavaMMPackage.Literals.ENUM_CONSTANT_DECLARATION__ARGUMENTS, Types._EnumConstantDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _EnumConstantDeclaration__EnumDeclaration__enumConstants = new ExecutorPropertyWithImplementation("EnumDeclaration", Types._EnumConstantDeclaration, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ENUM_DECLARATION__ENUM_CONSTANTS));

		public static final /*@NonNull*/ ExecutorProperty _EnumDeclaration__enumConstants = new EcoreExecutorProperty(JavaMMPackage.Literals.ENUM_DECLARATION__ENUM_CONSTANTS, Types._EnumDeclaration, 0);

		public static final /*@NonNull*/ ExecutorProperty _Expression__AbstractMethodInvocation__arguments = new ExecutorPropertyWithImplementation("AbstractMethodInvocation", Types._Expression, 0, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_INVOCATION__ARGUMENTS));
		public static final /*@NonNull*/ ExecutorProperty _Expression__AnnotationMemberValuePair__value = new ExecutorPropertyWithImplementation("AnnotationMemberValuePair", Types._Expression, 1, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ANNOTATION_MEMBER_VALUE_PAIR__VALUE));
		public static final /*@NonNull*/ ExecutorProperty _Expression__AnnotationTypeMemberDeclaration__default = new ExecutorPropertyWithImplementation("AnnotationTypeMemberDeclaration", Types._Expression, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ANNOTATION_TYPE_MEMBER_DECLARATION__DEFAULT));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ArrayAccess__array = new ExecutorPropertyWithImplementation("ArrayAccess", Types._Expression, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARRAY_ACCESS__ARRAY));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ArrayAccess__index = new ExecutorPropertyWithImplementation("ArrayAccess", Types._Expression, 4, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARRAY_ACCESS__INDEX));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ArrayCreation__dimensions = new ExecutorPropertyWithImplementation("ArrayCreation", Types._Expression, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARRAY_CREATION__DIMENSIONS));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ArrayInitializer__expressions = new ExecutorPropertyWithImplementation("ArrayInitializer", Types._Expression, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARRAY_INITIALIZER__EXPRESSIONS));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ArrayLengthAccess__array = new ExecutorPropertyWithImplementation("ArrayLengthAccess", Types._Expression, 7, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARRAY_LENGTH_ACCESS__ARRAY));
		public static final /*@NonNull*/ ExecutorProperty _Expression__AssertStatement__expression = new ExecutorPropertyWithImplementation("AssertStatement", Types._Expression, 8, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ASSERT_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__AssertStatement__message = new ExecutorPropertyWithImplementation("AssertStatement", Types._Expression, 9, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ASSERT_STATEMENT__MESSAGE));
		public static final /*@NonNull*/ ExecutorProperty _Expression__Assignment__leftHandSide = new ExecutorPropertyWithImplementation("Assignment", Types._Expression, 10, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ASSIGNMENT__LEFT_HAND_SIDE));
		public static final /*@NonNull*/ ExecutorProperty _Expression__Assignment__rightHandSide = new ExecutorPropertyWithImplementation("Assignment", Types._Expression, 11, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ASSIGNMENT__RIGHT_HAND_SIDE));
		public static final /*@NonNull*/ ExecutorProperty _Expression__CastExpression__expression = new ExecutorPropertyWithImplementation("CastExpression", Types._Expression, 12, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CAST_EXPRESSION__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ClassInstanceCreation__expression = new ExecutorPropertyWithImplementation("ClassInstanceCreation", Types._Expression, 13, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CLASS_INSTANCE_CREATION__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ConditionalExpression__elseExpression = new ExecutorPropertyWithImplementation("ConditionalExpression", Types._Expression, 14, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CONDITIONAL_EXPRESSION__ELSE_EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ConditionalExpression__expression = new ExecutorPropertyWithImplementation("ConditionalExpression", Types._Expression, 15, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CONDITIONAL_EXPRESSION__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ConditionalExpression__thenExpression = new ExecutorPropertyWithImplementation("ConditionalExpression", Types._Expression, 16, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CONDITIONAL_EXPRESSION__THEN_EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__DoStatement__expression = new ExecutorPropertyWithImplementation("DoStatement", Types._Expression, 17, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.DO_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__EnhancedForStatement__expression = new ExecutorPropertyWithImplementation("EnhancedForStatement", Types._Expression, 18, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ENHANCED_FOR_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__EnumConstantDeclaration__arguments = new ExecutorPropertyWithImplementation("EnumConstantDeclaration", Types._Expression, 19, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ENUM_CONSTANT_DECLARATION__ARGUMENTS));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ExpressionStatement__expression = new ExecutorPropertyWithImplementation("ExpressionStatement", Types._Expression, 20, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.EXPRESSION_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__FieldAccess__expression = new ExecutorPropertyWithImplementation("FieldAccess", Types._Expression, 21, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.FIELD_ACCESS__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ForStatement__expression = new ExecutorPropertyWithImplementation("ForStatement", Types._Expression, 22, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.FOR_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ForStatement__initializers = new ExecutorPropertyWithImplementation("ForStatement", Types._Expression, 23, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.FOR_STATEMENT__INITIALIZERS));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ForStatement__updaters = new ExecutorPropertyWithImplementation("ForStatement", Types._Expression, 24, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.FOR_STATEMENT__UPDATERS));
		public static final /*@NonNull*/ ExecutorProperty _Expression__IfStatement__expression = new ExecutorPropertyWithImplementation("IfStatement", Types._Expression, 25, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.IF_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__InfixExpression__extendedOperands = new ExecutorPropertyWithImplementation("InfixExpression", Types._Expression, 26, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.INFIX_EXPRESSION__EXTENDED_OPERANDS));
		public static final /*@NonNull*/ ExecutorProperty _Expression__InfixExpression__leftOperand = new ExecutorPropertyWithImplementation("InfixExpression", Types._Expression, 27, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.INFIX_EXPRESSION__LEFT_OPERAND));
		public static final /*@NonNull*/ ExecutorProperty _Expression__InfixExpression__rightOperand = new ExecutorPropertyWithImplementation("InfixExpression", Types._Expression, 28, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.INFIX_EXPRESSION__RIGHT_OPERAND));
		public static final /*@NonNull*/ ExecutorProperty _Expression__InstanceofExpression__leftOperand = new ExecutorPropertyWithImplementation("InstanceofExpression", Types._Expression, 29, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.INSTANCEOF_EXPRESSION__LEFT_OPERAND));
		public static final /*@NonNull*/ ExecutorProperty _Expression__MethodInvocation__expression = new ExecutorPropertyWithImplementation("MethodInvocation", Types._Expression, 30, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.METHOD_INVOCATION__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ParenthesizedExpression__expression = new ExecutorPropertyWithImplementation("ParenthesizedExpression", Types._Expression, 31, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.PARENTHESIZED_EXPRESSION__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__PostfixExpression__operand = new ExecutorPropertyWithImplementation("PostfixExpression", Types._Expression, 32, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.POSTFIX_EXPRESSION__OPERAND));
		public static final /*@NonNull*/ ExecutorProperty _Expression__PrefixExpression__operand = new ExecutorPropertyWithImplementation("PrefixExpression", Types._Expression, 33, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.PREFIX_EXPRESSION__OPERAND));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ReturnStatement__expression = new ExecutorPropertyWithImplementation("ReturnStatement", Types._Expression, 34, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.RETURN_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__SingleVariableAccess__qualifier = new ExecutorPropertyWithImplementation("SingleVariableAccess", Types._Expression, 35, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_ACCESS__QUALIFIER));
		public static final /*@NonNull*/ ExecutorProperty _Expression__SuperConstructorInvocation__expression = new ExecutorPropertyWithImplementation("SuperConstructorInvocation", Types._Expression, 36, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SUPER_CONSTRUCTOR_INVOCATION__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__SwitchCase__expression = new ExecutorPropertyWithImplementation("SwitchCase", Types._Expression, 37, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SWITCH_CASE__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__SwitchStatement__expression = new ExecutorPropertyWithImplementation("SwitchStatement", Types._Expression, 38, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SWITCH_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__SynchronizedStatement__expression = new ExecutorPropertyWithImplementation("SynchronizedStatement", Types._Expression, 39, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SYNCHRONIZED_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__ThrowStatement__expression = new ExecutorPropertyWithImplementation("ThrowStatement", Types._Expression, 40, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.THROW_STATEMENT__EXPRESSION));
		public static final /*@NonNull*/ ExecutorProperty _Expression__VariableDeclaration__initializer = new ExecutorPropertyWithImplementation("VariableDeclaration", Types._Expression, 41, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION__INITIALIZER));
		public static final /*@NonNull*/ ExecutorProperty _Expression__WhileStatement__expression = new ExecutorPropertyWithImplementation("WhileStatement", Types._Expression, 42, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.WHILE_STATEMENT__EXPRESSION));

		public static final /*@NonNull*/ ExecutorProperty _ExpressionStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.EXPRESSION_STATEMENT__EXPRESSION, Types._ExpressionStatement, 0);

		public static final /*@NonNull*/ ExecutorProperty _FieldAccess__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.FIELD_ACCESS__EXPRESSION, Types._FieldAccess, 0);
		public static final /*@NonNull*/ ExecutorProperty _FieldAccess__field = new EcoreExecutorProperty(JavaMMPackage.Literals.FIELD_ACCESS__FIELD, Types._FieldAccess, 1);

		public static final /*@NonNull*/ ExecutorProperty _ForStatement__body = new EcoreExecutorProperty(JavaMMPackage.Literals.FOR_STATEMENT__BODY, Types._ForStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _ForStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.FOR_STATEMENT__EXPRESSION, Types._ForStatement, 1);
		public static final /*@NonNull*/ ExecutorProperty _ForStatement__initializers = new EcoreExecutorProperty(JavaMMPackage.Literals.FOR_STATEMENT__INITIALIZERS, Types._ForStatement, 2);
		public static final /*@NonNull*/ ExecutorProperty _ForStatement__updaters = new EcoreExecutorProperty(JavaMMPackage.Literals.FOR_STATEMENT__UPDATERS, Types._ForStatement, 3);

		public static final /*@NonNull*/ ExecutorProperty _IfStatement__elseStatement = new EcoreExecutorProperty(JavaMMPackage.Literals.IF_STATEMENT__ELSE_STATEMENT, Types._IfStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _IfStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.IF_STATEMENT__EXPRESSION, Types._IfStatement, 1);
		public static final /*@NonNull*/ ExecutorProperty _IfStatement__thenStatement = new EcoreExecutorProperty(JavaMMPackage.Literals.IF_STATEMENT__THEN_STATEMENT, Types._IfStatement, 2);

		public static final /*@NonNull*/ ExecutorProperty _ImportDeclaration__importedElement = new EcoreExecutorProperty(JavaMMPackage.Literals.IMPORT_DECLARATION__IMPORTED_ELEMENT, Types._ImportDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _ImportDeclaration__static = new EcoreExecutorProperty(JavaMMPackage.Literals.IMPORT_DECLARATION__STATIC, Types._ImportDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _ImportDeclaration__CompilationUnit__imports = new ExecutorPropertyWithImplementation("CompilationUnit", Types._ImportDeclaration, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.COMPILATION_UNIT__IMPORTS));

		public static final /*@NonNull*/ ExecutorProperty _InfixExpression__extendedOperands = new EcoreExecutorProperty(JavaMMPackage.Literals.INFIX_EXPRESSION__EXTENDED_OPERANDS, Types._InfixExpression, 0);
		public static final /*@NonNull*/ ExecutorProperty _InfixExpression__leftOperand = new EcoreExecutorProperty(JavaMMPackage.Literals.INFIX_EXPRESSION__LEFT_OPERAND, Types._InfixExpression, 1);
		public static final /*@NonNull*/ ExecutorProperty _InfixExpression__operator = new EcoreExecutorProperty(JavaMMPackage.Literals.INFIX_EXPRESSION__OPERATOR, Types._InfixExpression, 2);
		public static final /*@NonNull*/ ExecutorProperty _InfixExpression__rightOperand = new EcoreExecutorProperty(JavaMMPackage.Literals.INFIX_EXPRESSION__RIGHT_OPERAND, Types._InfixExpression, 3);

		public static final /*@NonNull*/ ExecutorProperty _Initializer__body = new EcoreExecutorProperty(JavaMMPackage.Literals.INITIALIZER__BODY, Types._Initializer, 0);

		public static final /*@NonNull*/ ExecutorProperty _InstanceofExpression__leftOperand = new EcoreExecutorProperty(JavaMMPackage.Literals.INSTANCEOF_EXPRESSION__LEFT_OPERAND, Types._InstanceofExpression, 0);
		public static final /*@NonNull*/ ExecutorProperty _InstanceofExpression__rightOperand = new EcoreExecutorProperty(JavaMMPackage.Literals.INSTANCEOF_EXPRESSION__RIGHT_OPERAND, Types._InstanceofExpression, 1);

		public static final /*@NonNull*/ ExecutorProperty _Javadoc__tags = new EcoreExecutorProperty(JavaMMPackage.Literals.JAVADOC__TAGS, Types._Javadoc, 0);

		public static final /*@NonNull*/ ExecutorProperty _LabeledStatement__body = new EcoreExecutorProperty(JavaMMPackage.Literals.LABELED_STATEMENT__BODY, Types._LabeledStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _LabeledStatement__usagesInBreakStatements = new EcoreExecutorProperty(JavaMMPackage.Literals.LABELED_STATEMENT__USAGES_IN_BREAK_STATEMENTS, Types._LabeledStatement, 1);
		public static final /*@NonNull*/ ExecutorProperty _LabeledStatement__usagesInContinueStatements = new EcoreExecutorProperty(JavaMMPackage.Literals.LABELED_STATEMENT__USAGES_IN_CONTINUE_STATEMENTS, Types._LabeledStatement, 2);

		public static final /*@NonNull*/ ExecutorProperty _Manifest__entryAttributes = new EcoreExecutorProperty(JavaMMPackage.Literals.MANIFEST__ENTRY_ATTRIBUTES, Types._Manifest, 0);
		public static final /*@NonNull*/ ExecutorProperty _Manifest__mainAttributes = new EcoreExecutorProperty(JavaMMPackage.Literals.MANIFEST__MAIN_ATTRIBUTES, Types._Manifest, 1);
		public static final /*@NonNull*/ ExecutorProperty _Manifest__Archive__manifest = new ExecutorPropertyWithImplementation("Archive", Types._Manifest, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARCHIVE__MANIFEST));

		public static final /*@NonNull*/ ExecutorProperty _ManifestAttribute__key = new EcoreExecutorProperty(JavaMMPackage.Literals.MANIFEST_ATTRIBUTE__KEY, Types._ManifestAttribute, 0);
		public static final /*@NonNull*/ ExecutorProperty _ManifestAttribute__value = new EcoreExecutorProperty(JavaMMPackage.Literals.MANIFEST_ATTRIBUTE__VALUE, Types._ManifestAttribute, 1);
		public static final /*@NonNull*/ ExecutorProperty _ManifestAttribute__Manifest__mainAttributes = new ExecutorPropertyWithImplementation("Manifest", Types._ManifestAttribute, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MANIFEST__MAIN_ATTRIBUTES));
		public static final /*@NonNull*/ ExecutorProperty _ManifestAttribute__ManifestEntry__attributes = new ExecutorPropertyWithImplementation("ManifestEntry", Types._ManifestAttribute, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MANIFEST_ENTRY__ATTRIBUTES));

		public static final /*@NonNull*/ ExecutorProperty _ManifestEntry__attributes = new EcoreExecutorProperty(JavaMMPackage.Literals.MANIFEST_ENTRY__ATTRIBUTES, Types._ManifestEntry, 0);
		public static final /*@NonNull*/ ExecutorProperty _ManifestEntry__name = new EcoreExecutorProperty(JavaMMPackage.Literals.MANIFEST_ENTRY__NAME, Types._ManifestEntry, 1);
		public static final /*@NonNull*/ ExecutorProperty _ManifestEntry__Manifest__entryAttributes = new ExecutorPropertyWithImplementation("Manifest", Types._ManifestEntry, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MANIFEST__ENTRY_ATTRIBUTES));

		public static final /*@NonNull*/ ExecutorProperty _MemberRef__member = new EcoreExecutorProperty(JavaMMPackage.Literals.MEMBER_REF__MEMBER, Types._MemberRef, 0);
		public static final /*@NonNull*/ ExecutorProperty _MemberRef__qualifier = new EcoreExecutorProperty(JavaMMPackage.Literals.MEMBER_REF__QUALIFIER, Types._MemberRef, 1);

		public static final /*@NonNull*/ ExecutorProperty _MethodDeclaration__extraArrayDimensions = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_DECLARATION__EXTRA_ARRAY_DIMENSIONS, Types._MethodDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _MethodDeclaration__redefinedMethodDeclaration = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_DECLARATION__REDEFINED_METHOD_DECLARATION, Types._MethodDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _MethodDeclaration__redefinitions = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_DECLARATION__REDEFINITIONS, Types._MethodDeclaration, 2);
		public static final /*@NonNull*/ ExecutorProperty _MethodDeclaration__returnType = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_DECLARATION__RETURN_TYPE, Types._MethodDeclaration, 3);

		public static final /*@NonNull*/ ExecutorProperty _MethodInvocation__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_INVOCATION__EXPRESSION, Types._MethodInvocation, 0);

		public static final /*@NonNull*/ ExecutorProperty _MethodRef__method = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_REF__METHOD, Types._MethodRef, 0);
		public static final /*@NonNull*/ ExecutorProperty _MethodRef__parameters = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_REF__PARAMETERS, Types._MethodRef, 1);
		public static final /*@NonNull*/ ExecutorProperty _MethodRef__qualifier = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_REF__QUALIFIER, Types._MethodRef, 2);

		public static final /*@NonNull*/ ExecutorProperty _MethodRefParameter__name = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_REF_PARAMETER__NAME, Types._MethodRefParameter, 0);
		public static final /*@NonNull*/ ExecutorProperty _MethodRefParameter__type = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_REF_PARAMETER__TYPE, Types._MethodRefParameter, 1);
		public static final /*@NonNull*/ ExecutorProperty _MethodRefParameter__varargs = new EcoreExecutorProperty(JavaMMPackage.Literals.METHOD_REF_PARAMETER__VARARGS, Types._MethodRefParameter, 2);
		public static final /*@NonNull*/ ExecutorProperty _MethodRefParameter__MethodRef__parameters = new ExecutorPropertyWithImplementation("MethodRef", Types._MethodRefParameter, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.METHOD_REF__PARAMETERS));

		public static final /*@NonNull*/ ExecutorProperty _Model__archives = new EcoreExecutorProperty(JavaMMPackage.Literals.MODEL__ARCHIVES, Types._Model, 0);
		public static final /*@NonNull*/ ExecutorProperty _Model__classFiles = new EcoreExecutorProperty(JavaMMPackage.Literals.MODEL__CLASS_FILES, Types._Model, 1);
		public static final /*@NonNull*/ ExecutorProperty _Model__compilationUnits = new EcoreExecutorProperty(JavaMMPackage.Literals.MODEL__COMPILATION_UNITS, Types._Model, 2);
		public static final /*@NonNull*/ ExecutorProperty _Model__name = new EcoreExecutorProperty(JavaMMPackage.Literals.MODEL__NAME, Types._Model, 3);
		public static final /*@NonNull*/ ExecutorProperty _Model__orphanTypes = new EcoreExecutorProperty(JavaMMPackage.Literals.MODEL__ORPHAN_TYPES, Types._Model, 4);
		public static final /*@NonNull*/ ExecutorProperty _Model__ownedElements = new EcoreExecutorProperty(JavaMMPackage.Literals.MODEL__OWNED_ELEMENTS, Types._Model, 5);
		public static final /*@NonNull*/ ExecutorProperty _Model__unresolvedItems = new EcoreExecutorProperty(JavaMMPackage.Literals.MODEL__UNRESOLVED_ITEMS, Types._Model, 6);

		public static final /*@NonNull*/ ExecutorProperty _Modifier__bodyDeclaration = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__BODY_DECLARATION, Types._Modifier, 0);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__inheritance = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__INHERITANCE, Types._Modifier, 1);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__native = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__NATIVE, Types._Modifier, 2);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__singleVariableDeclaration = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__SINGLE_VARIABLE_DECLARATION, Types._Modifier, 3);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__static = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__STATIC, Types._Modifier, 4);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__strictfp = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__STRICTFP, Types._Modifier, 5);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__synchronized = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__SYNCHRONIZED, Types._Modifier, 6);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__transient = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__TRANSIENT, Types._Modifier, 7);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__variableDeclarationExpression = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__VARIABLE_DECLARATION_EXPRESSION, Types._Modifier, 8);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__variableDeclarationStatement = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__VARIABLE_DECLARATION_STATEMENT, Types._Modifier, 9);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__visibility = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__VISIBILITY, Types._Modifier, 10);
		public static final /*@NonNull*/ ExecutorProperty _Modifier__volatile = new EcoreExecutorProperty(JavaMMPackage.Literals.MODIFIER__VOLATILE, Types._Modifier, 11);

		public static final /*@NonNull*/ ExecutorProperty _NamedElement__name = new EcoreExecutorProperty(JavaMMPackage.Literals.NAMED_ELEMENT__NAME, Types._NamedElement, 0);
		public static final /*@NonNull*/ ExecutorProperty _NamedElement__proxy = new EcoreExecutorProperty(JavaMMPackage.Literals.NAMED_ELEMENT__PROXY, Types._NamedElement, 1);
		public static final /*@NonNull*/ ExecutorProperty _NamedElement__usagesInImports = new EcoreExecutorProperty(JavaMMPackage.Literals.NAMED_ELEMENT__USAGES_IN_IMPORTS, Types._NamedElement, 2);
		public static final /*@NonNull*/ ExecutorProperty _NamedElement__MemberRef__member = new ExecutorPropertyWithImplementation("MemberRef", Types._NamedElement, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MEMBER_REF__MEMBER));

		public static final /*@NonNull*/ ExecutorProperty _NamespaceAccess__TypeAccess__qualifier = new ExecutorPropertyWithImplementation("TypeAccess", Types._NamespaceAccess, 0, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TYPE_ACCESS__QUALIFIER));

		public static final /*@NonNull*/ ExecutorProperty _NumberLiteral__tokenValue = new EcoreExecutorProperty(JavaMMPackage.Literals.NUMBER_LITERAL__TOKEN_VALUE, Types._NumberLiteral, 0);

		public static final /*@NonNull*/ ExecutorProperty _Package__model = new EcoreExecutorProperty(JavaMMPackage.Literals.PACKAGE__MODEL, Types._Package, 0);
		public static final /*@NonNull*/ ExecutorProperty _Package__ownedElements = new EcoreExecutorProperty(JavaMMPackage.Literals.PACKAGE__OWNED_ELEMENTS, Types._Package, 1);
		public static final /*@NonNull*/ ExecutorProperty _Package__ownedPackages = new EcoreExecutorProperty(JavaMMPackage.Literals.PACKAGE__OWNED_PACKAGES, Types._Package, 2);
		public static final /*@NonNull*/ ExecutorProperty _Package__package = new EcoreExecutorProperty(JavaMMPackage.Literals.PACKAGE__PACKAGE, Types._Package, 3);
		public static final /*@NonNull*/ ExecutorProperty _Package__usagesInPackageAccess = new EcoreExecutorProperty(JavaMMPackage.Literals.PACKAGE__USAGES_IN_PACKAGE_ACCESS, Types._Package, 4);
		public static final /*@NonNull*/ ExecutorProperty _Package__ClassFile__package = new ExecutorPropertyWithImplementation("ClassFile", Types._Package, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CLASS_FILE__PACKAGE));
		public static final /*@NonNull*/ ExecutorProperty _Package__CompilationUnit__package = new ExecutorPropertyWithImplementation("CompilationUnit", Types._Package, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.COMPILATION_UNIT__PACKAGE));

		public static final /*@NonNull*/ ExecutorProperty _PackageAccess__package = new EcoreExecutorProperty(JavaMMPackage.Literals.PACKAGE_ACCESS__PACKAGE, Types._PackageAccess, 0);
		public static final /*@NonNull*/ ExecutorProperty _PackageAccess__qualifier = new EcoreExecutorProperty(JavaMMPackage.Literals.PACKAGE_ACCESS__QUALIFIER, Types._PackageAccess, 1);
		public static final /*@NonNull*/ ExecutorProperty _PackageAccess__PackageAccess__qualifier = new ExecutorPropertyWithImplementation("PackageAccess", Types._PackageAccess, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.PACKAGE_ACCESS__QUALIFIER));

		public static final /*@NonNull*/ ExecutorProperty _ParameterizedType__type = new EcoreExecutorProperty(JavaMMPackage.Literals.PARAMETERIZED_TYPE__TYPE, Types._ParameterizedType, 0);
		public static final /*@NonNull*/ ExecutorProperty _ParameterizedType__typeArguments = new EcoreExecutorProperty(JavaMMPackage.Literals.PARAMETERIZED_TYPE__TYPE_ARGUMENTS, Types._ParameterizedType, 1);

		public static final /*@NonNull*/ ExecutorProperty _ParenthesizedExpression__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.PARENTHESIZED_EXPRESSION__EXPRESSION, Types._ParenthesizedExpression, 0);

		public static final /*@NonNull*/ ExecutorProperty _PostfixExpression__operand = new EcoreExecutorProperty(JavaMMPackage.Literals.POSTFIX_EXPRESSION__OPERAND, Types._PostfixExpression, 0);
		public static final /*@NonNull*/ ExecutorProperty _PostfixExpression__operator = new EcoreExecutorProperty(JavaMMPackage.Literals.POSTFIX_EXPRESSION__OPERATOR, Types._PostfixExpression, 1);

		public static final /*@NonNull*/ ExecutorProperty _PrefixExpression__operand = new EcoreExecutorProperty(JavaMMPackage.Literals.PREFIX_EXPRESSION__OPERAND, Types._PrefixExpression, 0);
		public static final /*@NonNull*/ ExecutorProperty _PrefixExpression__operator = new EcoreExecutorProperty(JavaMMPackage.Literals.PREFIX_EXPRESSION__OPERATOR, Types._PrefixExpression, 1);

		public static final /*@NonNull*/ ExecutorProperty _ReturnStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.RETURN_STATEMENT__EXPRESSION, Types._ReturnStatement, 0);

		public static final /*@NonNull*/ ExecutorProperty _SingleVariableAccess__qualifier = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_ACCESS__QUALIFIER, Types._SingleVariableAccess, 0);
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableAccess__variable = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_ACCESS__VARIABLE, Types._SingleVariableAccess, 1);
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableAccess__FieldAccess__field = new ExecutorPropertyWithImplementation("FieldAccess", Types._SingleVariableAccess, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.FIELD_ACCESS__FIELD));
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableAccess__SuperFieldAccess__field = new ExecutorPropertyWithImplementation("SuperFieldAccess", Types._SingleVariableAccess, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SUPER_FIELD_ACCESS__FIELD));

		public static final /*@NonNull*/ ExecutorProperty _SingleVariableDeclaration__annotations = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__ANNOTATIONS, Types._SingleVariableDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableDeclaration__catchClause = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__CATCH_CLAUSE, Types._SingleVariableDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableDeclaration__enhancedForStatement = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__ENHANCED_FOR_STATEMENT, Types._SingleVariableDeclaration, 2);
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableDeclaration__methodDeclaration = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__METHOD_DECLARATION, Types._SingleVariableDeclaration, 3);
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableDeclaration__modifier = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__MODIFIER, Types._SingleVariableDeclaration, 4);
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableDeclaration__type = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__TYPE, Types._SingleVariableDeclaration, 5);
		public static final /*@NonNull*/ ExecutorProperty _SingleVariableDeclaration__varargs = new EcoreExecutorProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__VARARGS, Types._SingleVariableDeclaration, 6);

		public static final /*@NonNull*/ ExecutorProperty _Statement__Block__statements = new ExecutorPropertyWithImplementation("Block", Types._Statement, 0, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.BLOCK__STATEMENTS));
		public static final /*@NonNull*/ ExecutorProperty _Statement__DoStatement__body = new ExecutorPropertyWithImplementation("DoStatement", Types._Statement, 1, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.DO_STATEMENT__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Statement__EnhancedForStatement__body = new ExecutorPropertyWithImplementation("EnhancedForStatement", Types._Statement, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ENHANCED_FOR_STATEMENT__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Statement__ForStatement__body = new ExecutorPropertyWithImplementation("ForStatement", Types._Statement, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.FOR_STATEMENT__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Statement__IfStatement__elseStatement = new ExecutorPropertyWithImplementation("IfStatement", Types._Statement, 4, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.IF_STATEMENT__ELSE_STATEMENT));
		public static final /*@NonNull*/ ExecutorProperty _Statement__IfStatement__thenStatement = new ExecutorPropertyWithImplementation("IfStatement", Types._Statement, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.IF_STATEMENT__THEN_STATEMENT));
		public static final /*@NonNull*/ ExecutorProperty _Statement__LabeledStatement__body = new ExecutorPropertyWithImplementation("LabeledStatement", Types._Statement, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.LABELED_STATEMENT__BODY));
		public static final /*@NonNull*/ ExecutorProperty _Statement__SwitchStatement__statements = new ExecutorPropertyWithImplementation("SwitchStatement", Types._Statement, 7, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SWITCH_STATEMENT__STATEMENTS));
		public static final /*@NonNull*/ ExecutorProperty _Statement__WhileStatement__body = new ExecutorPropertyWithImplementation("WhileStatement", Types._Statement, 8, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.WHILE_STATEMENT__BODY));

		public static final /*@NonNull*/ ExecutorProperty _StringLiteral__escapedValue = new EcoreExecutorProperty(JavaMMPackage.Literals.STRING_LITERAL__ESCAPED_VALUE, Types._StringLiteral, 0);

		public static final /*@NonNull*/ ExecutorProperty _SuperConstructorInvocation__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.SUPER_CONSTRUCTOR_INVOCATION__EXPRESSION, Types._SuperConstructorInvocation, 0);

		public static final /*@NonNull*/ ExecutorProperty _SuperFieldAccess__field = new EcoreExecutorProperty(JavaMMPackage.Literals.SUPER_FIELD_ACCESS__FIELD, Types._SuperFieldAccess, 0);

		public static final /*@NonNull*/ ExecutorProperty _SwitchCase__default = new EcoreExecutorProperty(JavaMMPackage.Literals.SWITCH_CASE__DEFAULT, Types._SwitchCase, 0);
		public static final /*@NonNull*/ ExecutorProperty _SwitchCase__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.SWITCH_CASE__EXPRESSION, Types._SwitchCase, 1);

		public static final /*@NonNull*/ ExecutorProperty _SwitchStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.SWITCH_STATEMENT__EXPRESSION, Types._SwitchStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _SwitchStatement__statements = new EcoreExecutorProperty(JavaMMPackage.Literals.SWITCH_STATEMENT__STATEMENTS, Types._SwitchStatement, 1);

		public static final /*@NonNull*/ ExecutorProperty _SynchronizedStatement__body = new EcoreExecutorProperty(JavaMMPackage.Literals.SYNCHRONIZED_STATEMENT__BODY, Types._SynchronizedStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _SynchronizedStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.SYNCHRONIZED_STATEMENT__EXPRESSION, Types._SynchronizedStatement, 1);

		public static final /*@NonNull*/ ExecutorProperty _TagElement__fragments = new EcoreExecutorProperty(JavaMMPackage.Literals.TAG_ELEMENT__FRAGMENTS, Types._TagElement, 0);
		public static final /*@NonNull*/ ExecutorProperty _TagElement__tagName = new EcoreExecutorProperty(JavaMMPackage.Literals.TAG_ELEMENT__TAG_NAME, Types._TagElement, 1);
		public static final /*@NonNull*/ ExecutorProperty _TagElement__Javadoc__tags = new ExecutorPropertyWithImplementation("Javadoc", Types._TagElement, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.JAVADOC__TAGS));

		public static final /*@NonNull*/ ExecutorProperty _TextElement__text = new EcoreExecutorProperty(JavaMMPackage.Literals.TEXT_ELEMENT__TEXT, Types._TextElement, 0);

		public static final /*@NonNull*/ ExecutorProperty _ThrowStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.THROW_STATEMENT__EXPRESSION, Types._ThrowStatement, 0);

		public static final /*@NonNull*/ ExecutorProperty _TryStatement__body = new EcoreExecutorProperty(JavaMMPackage.Literals.TRY_STATEMENT__BODY, Types._TryStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _TryStatement__catchClauses = new EcoreExecutorProperty(JavaMMPackage.Literals.TRY_STATEMENT__CATCH_CLAUSES, Types._TryStatement, 1);
		public static final /*@NonNull*/ ExecutorProperty _TryStatement__finally = new EcoreExecutorProperty(JavaMMPackage.Literals.TRY_STATEMENT__FINALLY, Types._TryStatement, 2);

		public static final /*@NonNull*/ ExecutorProperty _Type__usagesInTypeAccess = new EcoreExecutorProperty(JavaMMPackage.Literals.TYPE__USAGES_IN_TYPE_ACCESS, Types._Type, 0);
		public static final /*@NonNull*/ ExecutorProperty _Type__Model__orphanTypes = new ExecutorPropertyWithImplementation("Model", Types._Type, 1, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MODEL__ORPHAN_TYPES));

		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__qualifier = new EcoreExecutorProperty(JavaMMPackage.Literals.TYPE_ACCESS__QUALIFIER, Types._TypeAccess, 0);
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__type = new EcoreExecutorProperty(JavaMMPackage.Literals.TYPE_ACCESS__TYPE, Types._TypeAccess, 1);
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__AbstractMethodDeclaration__thrownExceptions = new ExecutorPropertyWithImplementation("AbstractMethodDeclaration", Types._TypeAccess, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__THROWN_EXCEPTIONS));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__AbstractMethodInvocation__typeArguments = new ExecutorPropertyWithImplementation("AbstractMethodInvocation", Types._TypeAccess, 3, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_INVOCATION__TYPE_ARGUMENTS));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__AbstractTypeDeclaration__superInterfaces = new ExecutorPropertyWithImplementation("AbstractTypeDeclaration", Types._TypeAccess, 4, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_DECLARATION__SUPER_INTERFACES));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__AbstractTypeQualifiedExpression__qualifier = new ExecutorPropertyWithImplementation("AbstractTypeQualifiedExpression", Types._TypeAccess, 5, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_TYPE_QUALIFIED_EXPRESSION__QUALIFIER));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__AbstractVariablesContainer__type = new ExecutorPropertyWithImplementation("AbstractVariablesContainer", Types._TypeAccess, 6, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_VARIABLES_CONTAINER__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__Annotation__type = new ExecutorPropertyWithImplementation("Annotation", Types._TypeAccess, 7, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ANNOTATION__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__AnnotationTypeMemberDeclaration__type = new ExecutorPropertyWithImplementation("AnnotationTypeMemberDeclaration", Types._TypeAccess, 8, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ANNOTATION_TYPE_MEMBER_DECLARATION__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__ArrayCreation__type = new ExecutorPropertyWithImplementation("ArrayCreation", Types._TypeAccess, 9, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARRAY_CREATION__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__ArrayType__elementType = new ExecutorPropertyWithImplementation("ArrayType", Types._TypeAccess, 10, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ARRAY_TYPE__ELEMENT_TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__CastExpression__type = new ExecutorPropertyWithImplementation("CastExpression", Types._TypeAccess, 11, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CAST_EXPRESSION__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__ClassDeclaration__superClass = new ExecutorPropertyWithImplementation("ClassDeclaration", Types._TypeAccess, 12, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CLASS_DECLARATION__SUPER_CLASS));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__ClassInstanceCreation__type = new ExecutorPropertyWithImplementation("ClassInstanceCreation", Types._TypeAccess, 13, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.CLASS_INSTANCE_CREATION__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__InstanceofExpression__rightOperand = new ExecutorPropertyWithImplementation("InstanceofExpression", Types._TypeAccess, 14, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.INSTANCEOF_EXPRESSION__RIGHT_OPERAND));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__MemberRef__qualifier = new ExecutorPropertyWithImplementation("MemberRef", Types._TypeAccess, 15, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MEMBER_REF__QUALIFIER));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__MethodDeclaration__returnType = new ExecutorPropertyWithImplementation("MethodDeclaration", Types._TypeAccess, 16, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.METHOD_DECLARATION__RETURN_TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__MethodRef__qualifier = new ExecutorPropertyWithImplementation("MethodRef", Types._TypeAccess, 17, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.METHOD_REF__QUALIFIER));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__MethodRefParameter__type = new ExecutorPropertyWithImplementation("MethodRefParameter", Types._TypeAccess, 18, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.METHOD_REF_PARAMETER__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__ParameterizedType__type = new ExecutorPropertyWithImplementation("ParameterizedType", Types._TypeAccess, 19, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.PARAMETERIZED_TYPE__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__ParameterizedType__typeArguments = new ExecutorPropertyWithImplementation("ParameterizedType", Types._TypeAccess, 20, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.PARAMETERIZED_TYPE__TYPE_ARGUMENTS));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__SingleVariableDeclaration__type = new ExecutorPropertyWithImplementation("SingleVariableDeclaration", Types._TypeAccess, 21, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.SINGLE_VARIABLE_DECLARATION__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__TypeLiteral__type = new ExecutorPropertyWithImplementation("TypeLiteral", Types._TypeAccess, 22, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TYPE_LITERAL__TYPE));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__TypeParameter__bounds = new ExecutorPropertyWithImplementation("TypeParameter", Types._TypeAccess, 23, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TYPE_PARAMETER__BOUNDS));
		public static final /*@NonNull*/ ExecutorProperty _TypeAccess__WildCardType__bound = new ExecutorPropertyWithImplementation("WildCardType", Types._TypeAccess, 24, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.WILD_CARD_TYPE__BOUND));

		public static final /*@NonNull*/ ExecutorProperty _TypeDeclaration__typeParameters = new EcoreExecutorProperty(JavaMMPackage.Literals.TYPE_DECLARATION__TYPE_PARAMETERS, Types._TypeDeclaration, 0);

		public static final /*@NonNull*/ ExecutorProperty _TypeDeclarationStatement__declaration = new EcoreExecutorProperty(JavaMMPackage.Literals.TYPE_DECLARATION_STATEMENT__DECLARATION, Types._TypeDeclarationStatement, 0);

		public static final /*@NonNull*/ ExecutorProperty _TypeLiteral__type = new EcoreExecutorProperty(JavaMMPackage.Literals.TYPE_LITERAL__TYPE, Types._TypeLiteral, 0);

		public static final /*@NonNull*/ ExecutorProperty _TypeParameter__bounds = new EcoreExecutorProperty(JavaMMPackage.Literals.TYPE_PARAMETER__BOUNDS, Types._TypeParameter, 0);
		public static final /*@NonNull*/ ExecutorProperty _TypeParameter__AbstractMethodDeclaration__typeParameters = new ExecutorPropertyWithImplementation("AbstractMethodDeclaration", Types._TypeParameter, 1, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.ABSTRACT_METHOD_DECLARATION__TYPE_PARAMETERS));
		public static final /*@NonNull*/ ExecutorProperty _TypeParameter__TypeDeclaration__typeParameters = new ExecutorPropertyWithImplementation("TypeDeclaration", Types._TypeParameter, 2, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.TYPE_DECLARATION__TYPE_PARAMETERS));

		public static final /*@NonNull*/ ExecutorProperty _UnresolvedItem__Model__unresolvedItems = new ExecutorPropertyWithImplementation("Model", Types._UnresolvedItem, 0, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.MODEL__UNRESOLVED_ITEMS));
		public static final /*@NonNull*/ ExecutorProperty _UnresolvedItem__UnresolvedItemAccess__element = new ExecutorPropertyWithImplementation("UnresolvedItemAccess", Types._UnresolvedItem, 1, new EcoreLibraryOppositeProperty(JavaMMPackage.Literals.UNRESOLVED_ITEM_ACCESS__ELEMENT));

		public static final /*@NonNull*/ ExecutorProperty _UnresolvedItemAccess__element = new EcoreExecutorProperty(JavaMMPackage.Literals.UNRESOLVED_ITEM_ACCESS__ELEMENT, Types._UnresolvedItemAccess, 0);
		public static final /*@NonNull*/ ExecutorProperty _UnresolvedItemAccess__qualifier = new EcoreExecutorProperty(JavaMMPackage.Literals.UNRESOLVED_ITEM_ACCESS__QUALIFIER, Types._UnresolvedItemAccess, 1);

		public static final /*@NonNull*/ ExecutorProperty _VariableDeclaration__extraArrayDimensions = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION__EXTRA_ARRAY_DIMENSIONS, Types._VariableDeclaration, 0);
		public static final /*@NonNull*/ ExecutorProperty _VariableDeclaration__initializer = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION__INITIALIZER, Types._VariableDeclaration, 1);
		public static final /*@NonNull*/ ExecutorProperty _VariableDeclaration__usageInVariableAccess = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION__USAGE_IN_VARIABLE_ACCESS, Types._VariableDeclaration, 2);

		public static final /*@NonNull*/ ExecutorProperty _VariableDeclarationExpression__annotations = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION_EXPRESSION__ANNOTATIONS, Types._VariableDeclarationExpression, 0);
		public static final /*@NonNull*/ ExecutorProperty _VariableDeclarationExpression__modifier = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION_EXPRESSION__MODIFIER, Types._VariableDeclarationExpression, 1);

		public static final /*@NonNull*/ ExecutorProperty _VariableDeclarationFragment__variablesContainer = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION_FRAGMENT__VARIABLES_CONTAINER, Types._VariableDeclarationFragment, 0);

		public static final /*@NonNull*/ ExecutorProperty _VariableDeclarationStatement__annotations = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION_STATEMENT__ANNOTATIONS, Types._VariableDeclarationStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _VariableDeclarationStatement__extraArrayDimensions = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION_STATEMENT__EXTRA_ARRAY_DIMENSIONS, Types._VariableDeclarationStatement, 1);
		public static final /*@NonNull*/ ExecutorProperty _VariableDeclarationStatement__modifier = new EcoreExecutorProperty(JavaMMPackage.Literals.VARIABLE_DECLARATION_STATEMENT__MODIFIER, Types._VariableDeclarationStatement, 2);

		public static final /*@NonNull*/ ExecutorProperty _WhileStatement__body = new EcoreExecutorProperty(JavaMMPackage.Literals.WHILE_STATEMENT__BODY, Types._WhileStatement, 0);
		public static final /*@NonNull*/ ExecutorProperty _WhileStatement__expression = new EcoreExecutorProperty(JavaMMPackage.Literals.WHILE_STATEMENT__EXPRESSION, Types._WhileStatement, 1);

		public static final /*@NonNull*/ ExecutorProperty _WildCardType__bound = new EcoreExecutorProperty(JavaMMPackage.Literals.WILD_CARD_TYPE__BOUND, Types._WildCardType, 0);
		public static final /*@NonNull*/ ExecutorProperty _WildCardType__upperBound = new EcoreExecutorProperty(JavaMMPackage.Literals.WILD_CARD_TYPE__UPPER_BOUND, Types._WildCardType, 1);
		static {
			Init.initEnd();
		}

		/**
		 * Force initialization of the fields of JavaMMTables::Properties and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class TypeFragments {
		...
		/**
		 * Force initialization of the fields of JavaMMTables::TypeFragments and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class FragmentOperations {
		...
		private static final /*@NonNull*/ ExecutorOperation /*@NonNull*/ [] _AbstractTypeDeclaration__AbstractTypeDeclaration = {
			JavaMMTables.Operations._AbstractTypeDeclaration__implements /* implements(String[?]) */
		};
		...
		private static final /*@NonNull*/ ExecutorOperation /*@NonNull*/ [] _ClassDeclaration__ClassDeclaration = {
			JavaMMTables.Operations._ClassDeclaration__getMethods /* getMethods() */,
			JavaMMTables.Operations._ClassDeclaration__hasCompareTo /* hasCompareTo() */,
			JavaMMTables.Operations._ClassDeclaration__hasEquals /* hasEquals() */,
			JavaMMTables.Operations._ClassDeclaration__hasHashcode /* hasHashcode() */
		};
		...
		private static final /*@NonNull*/ ExecutorOperation /*@NonNull*/ [] _InfixExpression__InfixExpression = {
			JavaMMTables.Operations._InfixExpression__operatorIsEquality /* operatorIsEquality() */
		};
		...
		private static final /*@NonNull*/ ExecutorOperation /*@NonNull*/ [] _Modifier__Modifier = {
			JavaMMTables.Operations._Modifier__isLocal /* isLocal() */
		};
		...
		/**
		 * Force initialization of the fields of JavaMMTables::FragmentOperations and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class FragmentProperties {
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ASTNode = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AbstractMethodDeclaration = {
			JavaMMTables.Properties._BodyDeclaration__abstractTypeDeclaration,
			JavaMMTables.Properties._BodyDeclaration__annotations,
			JavaMMTables.Properties._BodyDeclaration__anonymousClassDeclarationOwner,
			JavaMMTables.Properties._AbstractMethodDeclaration__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._BodyDeclaration__modifier,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractMethodDeclaration__parameters,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._AbstractMethodDeclaration__thrownExceptions,
			JavaMMTables.Properties._AbstractMethodDeclaration__typeParameters,
			JavaMMTables.Properties._AbstractMethodDeclaration__usages,
			JavaMMTables.Properties._AbstractMethodDeclaration__usagesInDocComments,
			JavaMMTables.Properties._NamedElement__usagesInImports
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AbstractMethodInvocation = {
			JavaMMTables.Properties._AbstractMethodInvocation__arguments,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._AbstractMethodInvocation__method,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractMethodInvocation__typeArguments
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AbstractTypeDeclaration = {
			...
			JavaMMTables.Properties._BodyDeclaration__annotations,
			JavaMMTables.Properties._BodyDeclaration__anonymousClassDeclarationOwner,
			JavaMMTables.Properties._AbstractTypeDeclaration__bodyDeclarations,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._AbstractTypeDeclaration__commentsAfterBody,
			JavaMMTables.Properties._AbstractTypeDeclaration__commentsBeforeBody,
			JavaMMTables.Properties._BodyDeclaration__modifier,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractTypeDeclaration__package,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._AbstractTypeDeclaration__superInterfaces,
			JavaMMTables.Properties._NamedElement__usagesInImports,
			JavaMMTables.Properties._Type__usagesInTypeAccess
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AbstractTypeQualifiedExpression = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractTypeQualifiedExpression__qualifier
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AbstractVariablesContainer = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._AbstractVariablesContainer__fragments,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractVariablesContainer__type
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Annotation = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._Annotation__type,
			JavaMMTables.Properties._Annotation__values
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AnnotationMemberValuePair = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._AnnotationMemberValuePair__member,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._NamedElement__usagesInImports,
			JavaMMTables.Properties._AnnotationMemberValuePair__value
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AnnotationTypeMemberDeclaration = {
			...
			JavaMMTables.Properties._BodyDeclaration__anonymousClassDeclarationOwner,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._AnnotationTypeMemberDeclaration__default,
			JavaMMTables.Properties._BodyDeclaration__modifier,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._AnnotationTypeMemberDeclaration__type,
			JavaMMTables.Properties._AnnotationTypeMemberDeclaration__usages,
			JavaMMTables.Properties._NamedElement__usagesInImports
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AnonymousClassDeclaration = {
			JavaMMTables.Properties._AnonymousClassDeclaration__bodyDeclarations,
			JavaMMTables.Properties._AnonymousClassDeclaration__classInstanceCreation,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Archive = {
			JavaMMTables.Properties._Archive__classFiles,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._Archive__manifest,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._Archive__originalFilePath,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._NamedElement__usagesInImports
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ArrayAccess = {
			JavaMMTables.Properties._ArrayAccess__array,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ArrayAccess__index,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ArrayCreation = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ArrayCreation__dimensions,
			JavaMMTables.Properties._ArrayCreation__initializer,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._ArrayCreation__type
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ArrayInitializer = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ArrayInitializer__expressions,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ArrayLengthAccess = {
			JavaMMTables.Properties._ArrayLengthAccess__array,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ArrayType = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ArrayType__dimensions,
			JavaMMTables.Properties._ArrayType__elementType,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NamedElement__proxy,
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _AssertStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._AssertStatement__expression,
			JavaMMTables.Properties._AssertStatement__message,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Assignment = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._Assignment__leftHandSide,
			JavaMMTables.Properties._Assignment__operator,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._Assignment__rightHandSide
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Block = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._Block__statements
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _BlockComment = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._Comment__content,
			JavaMMTables.Properties._Comment__enclosedByParent,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._Comment__prefixOfParent
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _BooleanLiteral = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._BooleanLiteral__value
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _BreakStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._BreakStatement__label,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _CastExpression = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._CastExpression__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._CastExpression__type
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _CatchClause = {
			JavaMMTables.Properties._CatchClause__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._CatchClause__exception,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _CharacterLiteral = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._CharacterLiteral__escapedValue,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ClassDeclaration = {
			...
			JavaMMTables.Properties._AbstractTypeDeclaration__package,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._ClassDeclaration__superClass,
			JavaMMTables.Properties._AbstractTypeDeclaration__superInterfaces,
			JavaMMTables.Properties._TypeDeclaration__typeParameters,
			JavaMMTables.Properties._NamedElement__usagesInImports,
			JavaMMTables.Properties._Type__usagesInTypeAccess
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ClassFile = {
			JavaMMTables.Properties._ClassFile__attachedSource,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._ClassFile__originalFilePath,
			JavaMMTables.Properties._ClassFile__package,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._ClassFile__type,
			JavaMMTables.Properties._NamedElement__usagesInImports
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ClassInstanceCreation = {
			JavaMMTables.Properties._ClassInstanceCreation__anonymousClassDeclaration,
			JavaMMTables.Properties._AbstractMethodInvocation__arguments,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ClassInstanceCreation__expression,
			JavaMMTables.Properties._AbstractMethodInvocation__method,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._ClassInstanceCreation__type,
			JavaMMTables.Properties._AbstractMethodInvocation__typeArguments
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _CompilationUnit = {
			JavaMMTables.Properties._CompilationUnit__commentList,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._CompilationUnit__imports,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._CompilationUnit__originalFilePath,
			JavaMMTables.Properties._CompilationUnit__package,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._CompilationUnit__types,
			JavaMMTables.Properties._NamedElement__usagesInImports
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ConditionalExpression = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ConditionalExpression__elseExpression,
			JavaMMTables.Properties._ConditionalExpression__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._ConditionalExpression__thenExpression
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ContinueStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ContinueStatement__label,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _DoStatement = {
			JavaMMTables.Properties._DoStatement__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._DoStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _EnhancedForStatement = {
			JavaMMTables.Properties._EnhancedForStatement__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._EnhancedForStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._EnhancedForStatement__parameter
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _EnumConstantDeclaration = {
			JavaMMTables.Properties._BodyDeclaration__abstractTypeDeclaration,
			JavaMMTables.Properties._BodyDeclaration__annotations,
			JavaMMTables.Properties._EnumConstantDeclaration__anonymousClassDeclaration,
			JavaMMTables.Properties._BodyDeclaration__anonymousClassDeclarationOwner,
			JavaMMTables.Properties._EnumConstantDeclaration__arguments,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._VariableDeclaration__extraArrayDimensions,
			JavaMMTables.Properties._VariableDeclaration__initializer,
			JavaMMTables.Properties._BodyDeclaration__modifier,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._VariableDeclaration__usageInVariableAccess,
			JavaMMTables.Properties._NamedElement__usagesInImports
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _EnumDeclaration = {
			...
			JavaMMTables.Properties._AbstractTypeDeclaration__commentsAfterBody,
			JavaMMTables.Properties._AbstractTypeDeclaration__commentsBeforeBody,
			JavaMMTables.Properties._EnumDeclaration__enumConstants,
			JavaMMTables.Properties._BodyDeclaration__modifier,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ExpressionStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ExpressionStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _FieldAccess = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._FieldAccess__expression,
			JavaMMTables.Properties._FieldAccess__field,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ForStatement = {
			JavaMMTables.Properties._ForStatement__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ForStatement__expression,
			JavaMMTables.Properties._ForStatement__initializers,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._ForStatement__updaters
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _IfStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._IfStatement__elseStatement,
			JavaMMTables.Properties._IfStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._IfStatement__thenStatement
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ImportDeclaration = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ImportDeclaration__importedElement,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._ImportDeclaration__static
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _InfixExpression = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._InfixExpression__extendedOperands,
			JavaMMTables.Properties._InfixExpression__leftOperand,
			JavaMMTables.Properties._InfixExpression__operator,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._InfixExpression__rightOperand
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Initializer = {
			...
			JavaMMTables.Properties._BodyDeclaration__annotations,
			JavaMMTables.Properties._BodyDeclaration__anonymousClassDeclarationOwner,
			JavaMMTables.Properties._Initializer__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._BodyDeclaration__modifier,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _InstanceofExpression = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._InstanceofExpression__leftOperand,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._InstanceofExpression__rightOperand
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Javadoc = {
			...
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._Comment__prefixOfParent,
			JavaMMTables.Properties._Javadoc__tags
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _LabeledStatement = {
			JavaMMTables.Properties._LabeledStatement__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._LabeledStatement__usagesInBreakStatements,
			JavaMMTables.Properties._LabeledStatement__usagesInContinueStatements,
			JavaMMTables.Properties._NamedElement__usagesInImports
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Manifest = {
			JavaMMTables.Properties._Manifest__entryAttributes,
			JavaMMTables.Properties._Manifest__mainAttributes
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ManifestAttribute = {
			JavaMMTables.Properties._ManifestAttribute__key,
			JavaMMTables.Properties._ManifestAttribute__value
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ManifestEntry = {
			JavaMMTables.Properties._ManifestEntry__attributes,
			JavaMMTables.Properties._ManifestEntry__name
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _MemberRef = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._MemberRef__member,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._MemberRef__qualifier
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _MethodDeclaration = {
			...
			JavaMMTables.Properties._AbstractMethodDeclaration__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._MethodDeclaration__extraArrayDimensions,
			JavaMMTables.Properties._BodyDeclaration__modifier,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractMethodDeclaration__parameters,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._MethodDeclaration__redefinedMethodDeclaration,
			JavaMMTables.Properties._MethodDeclaration__redefinitions,
			JavaMMTables.Properties._MethodDeclaration__returnType,
			JavaMMTables.Properties._AbstractMethodDeclaration__thrownExceptions,
			JavaMMTables.Properties._AbstractMethodDeclaration__typeParameters,
			JavaMMTables.Properties._AbstractMethodDeclaration__usages,
			JavaMMTables.Properties._AbstractMethodDeclaration__usagesInDocComments,
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _MethodInvocation = {
			JavaMMTables.Properties._AbstractMethodInvocation__arguments,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._MethodInvocation__expression,
			JavaMMTables.Properties._AbstractMethodInvocation__method,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractMethodInvocation__typeArguments
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _MethodRef = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._MethodRef__method,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._MethodRef__parameters,
			JavaMMTables.Properties._MethodRef__qualifier
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _MethodRefParameter = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._MethodRefParameter__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._MethodRefParameter__type,
			JavaMMTables.Properties._MethodRefParameter__varargs
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Model = {
			JavaMMTables.Properties._Model__archives,
			JavaMMTables.Properties._Model__classFiles,
			JavaMMTables.Properties._Model__compilationUnits,
			JavaMMTables.Properties._Model__name,
			JavaMMTables.Properties._Model__orphanTypes,
			JavaMMTables.Properties._Model__ownedElements,
			JavaMMTables.Properties._Model__unresolvedItems
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Modifier = {
			JavaMMTables.Properties._Modifier__bodyDeclaration,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._Modifier__inheritance,
			JavaMMTables.Properties._Modifier__native,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._Modifier__singleVariableDeclaration,
			JavaMMTables.Properties._Modifier__static,
			JavaMMTables.Properties._Modifier__strictfp,
			JavaMMTables.Properties._Modifier__synchronized,
			JavaMMTables.Properties._Modifier__transient,
			JavaMMTables.Properties._Modifier__variableDeclarationExpression,
			JavaMMTables.Properties._Modifier__variableDeclarationStatement,
			JavaMMTables.Properties._Modifier__visibility,
			JavaMMTables.Properties._Modifier__volatile
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _NumberLiteral = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NumberLiteral__tokenValue
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _Package = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._Package__model,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._Package__ownedElements,
			JavaMMTables.Properties._Package__ownedPackages,
			JavaMMTables.Properties._Package__package,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._NamedElement__usagesInImports,
			JavaMMTables.Properties._Package__usagesInPackageAccess
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _PackageAccess = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._PackageAccess__package,
			JavaMMTables.Properties._PackageAccess__qualifier
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ParameterizedType = {
			...
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._ParameterizedType__type,
			JavaMMTables.Properties._ParameterizedType__typeArguments,
			JavaMMTables.Properties._NamedElement__usagesInImports,
			JavaMMTables.Properties._Type__usagesInTypeAccess
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ParenthesizedExpression = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ParenthesizedExpression__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _PostfixExpression = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._PostfixExpression__operand,
			JavaMMTables.Properties._PostfixExpression__operator,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _PrefixExpression = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._PrefixExpression__operand,
			JavaMMTables.Properties._PrefixExpression__operator,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ReturnStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ReturnStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _SingleVariableAccess = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._SingleVariableAccess__qualifier,
			JavaMMTables.Properties._SingleVariableAccess__variable
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _SingleVariableDeclaration = {
			JavaMMTables.Properties._SingleVariableDeclaration__annotations,
			JavaMMTables.Properties._SingleVariableDeclaration__catchClause,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._SingleVariableDeclaration__enhancedForStatement,
			JavaMMTables.Properties._VariableDeclaration__extraArrayDimensions,
			JavaMMTables.Properties._VariableDeclaration__initializer,
			JavaMMTables.Properties._SingleVariableDeclaration__methodDeclaration,
			JavaMMTables.Properties._SingleVariableDeclaration__modifier,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._SingleVariableDeclaration__type,
			JavaMMTables.Properties._VariableDeclaration__usageInVariableAccess,
			JavaMMTables.Properties._NamedElement__usagesInImports,
			JavaMMTables.Properties._SingleVariableDeclaration__varargs
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _StringLiteral = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._StringLiteral__escapedValue,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _SuperConstructorInvocation = {
			JavaMMTables.Properties._AbstractMethodInvocation__arguments,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._SuperConstructorInvocation__expression,
			JavaMMTables.Properties._AbstractMethodInvocation__method,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractMethodInvocation__typeArguments
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _SuperFieldAccess = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._SuperFieldAccess__field,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractTypeQualifiedExpression__qualifier
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _SwitchCase = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._SwitchCase__default,
			JavaMMTables.Properties._SwitchCase__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _SwitchStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._SwitchStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._SwitchStatement__statements
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _SynchronizedStatement = {
			JavaMMTables.Properties._SynchronizedStatement__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._SynchronizedStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _TagElement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._TagElement__fragments,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._TagElement__tagName
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _TextElement = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._TextElement__text
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _ThrowStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._ThrowStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _TryStatement = {
			JavaMMTables.Properties._TryStatement__body,
			JavaMMTables.Properties._TryStatement__catchClauses,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._TryStatement__finally,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _TypeAccess = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._TypeAccess__qualifier,
			JavaMMTables.Properties._TypeAccess__type
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _TypeDeclarationStatement = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._TypeDeclarationStatement__declaration,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _TypeLiteral = {
			...
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._TypeLiteral__type
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _TypeParameter = {
			JavaMMTables.Properties._TypeParameter__bounds,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _UnresolvedItemAccess = {
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._UnresolvedItemAccess__element,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._UnresolvedItemAccess__qualifier
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _UnresolvedVariableDeclarationFragment = {
			...
			JavaMMTables.Properties._VariableDeclaration__usageInVariableAccess,
			JavaMMTables.Properties._NamedElement__usagesInImports,
			JavaMMTables.Properties._VariableDeclarationFragment__variablesContainer
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _VariableDeclarationExpression = {
			JavaMMTables.Properties._VariableDeclarationExpression__annotations,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._AbstractVariablesContainer__fragments,
			JavaMMTables.Properties._VariableDeclarationExpression__modifier,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractVariablesContainer__type
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _VariableDeclarationStatement = {
			JavaMMTables.Properties._VariableDeclarationStatement__annotations,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._VariableDeclarationStatement__extraArrayDimensions,
			JavaMMTables.Properties._AbstractVariablesContainer__fragments,
			JavaMMTables.Properties._VariableDeclarationStatement__modifier,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._AbstractVariablesContainer__type
		};
		...
		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _WhileStatement = {
			JavaMMTables.Properties._WhileStatement__body,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._WhileStatement__expression,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit
		};

		private static final /*@NonNull*/ ExecutorProperty /*@NonNull*/ [] _WildCardType = {
			JavaMMTables.Properties._WildCardType__bound,
			JavaMMTables.Properties._ASTNode__comments,
			JavaMMTables.Properties._NamedElement__name,
			JavaMMTables.Properties._ASTNode__originalClassFile,
			JavaMMTables.Properties._ASTNode__originalCompilationUnit,
			JavaMMTables.Properties._NamedElement__proxy,
			JavaMMTables.Properties._WildCardType__upperBound,
			JavaMMTables.Properties._NamedElement__usagesInImports,
			JavaMMTables.Properties._Type__usagesInTypeAccess
		};
		...
		/**
		 * Force initialization of the fields of JavaMMTables::FragmentProperties and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class EnumerationLiterals {
		...
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("ASSIGN"), Types._AssignmentKind, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__PLUS_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("PLUS_ASSIGN"), Types._AssignmentKind, 1);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__MINUS_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("MINUS_ASSIGN"), Types._AssignmentKind, 2);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__TIMES_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("TIMES_ASSIGN"), Types._AssignmentKind, 3);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__DIVIDE_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("DIVIDE_ASSIGN"), Types._AssignmentKind, 4);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__BIT_AND_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("BIT_AND_ASSIGN"), Types._AssignmentKind, 5);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__BIT_OR_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("BIT_OR_ASSIGN"), Types._AssignmentKind, 6);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__BIT_XOR_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("BIT_XOR_ASSIGN"), Types._AssignmentKind, 7);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__REMAINDER_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("REMAINDER_ASSIGN"), Types._AssignmentKind, 8);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__LEFT_SHIFT_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("LEFT_SHIFT_ASSIGN"), Types._AssignmentKind, 9);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__RIGHT_SHIFT_SIGNED_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("RIGHT_SHIFT_SIGNED_ASSIGN"), Types._AssignmentKind, 10);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _AssignmentKind__RIGHT_SHIFT_UNSIGNED_ASSIGN = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.ASSIGNMENT_KIND.getEEnumLiteral("RIGHT_SHIFT_UNSIGNED_ASSIGN"), Types._AssignmentKind, 11);
		...
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__TIMES = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("TIMES"), Types._InfixExpressionKind, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__DIVIDE = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("DIVIDE"), Types._InfixExpressionKind, 1);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__REMAINDER = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("REMAINDER"), Types._InfixExpressionKind, 2);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__PLUS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("PLUS"), Types._InfixExpressionKind, 3);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__MINUS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("MINUS"), Types._InfixExpressionKind, 4);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__LEFT_SHIFT = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("LEFT_SHIFT"), Types._InfixExpressionKind, 5);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__RIGHT_SHIFT_SIGNED = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("RIGHT_SHIFT_SIGNED"), Types._InfixExpressionKind, 6);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__RIGHT_SHIFT_UNSIGNED = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("RIGHT_SHIFT_UNSIGNED"), Types._InfixExpressionKind, 7);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__LESS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("LESS"), Types._InfixExpressionKind, 8);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__GREATER = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("GREATER"), Types._InfixExpressionKind, 9);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__LESS_EQUALS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("LESS_EQUALS"), Types._InfixExpressionKind, 10);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__GREATER_EQUALS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("GREATER_EQUALS"), Types._InfixExpressionKind, 11);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__EQUALS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("EQUALS"), Types._InfixExpressionKind, 12);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__NOT_EQUALS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("NOT_EQUALS"), Types._InfixExpressionKind, 13);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__XOR = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("XOR"), Types._InfixExpressionKind, 14);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__AND = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("AND"), Types._InfixExpressionKind, 15);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__OR = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("OR"), Types._InfixExpressionKind, 16);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__CONDITIONAL_AND = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("CONDITIONAL_AND"), Types._InfixExpressionKind, 17);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InfixExpressionKind__CONDITIONAL_OR = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INFIX_EXPRESSION_KIND.getEEnumLiteral("CONDITIONAL_OR"), Types._InfixExpressionKind, 18);
		...
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InheritanceKind__none = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INHERITANCE_KIND.getEEnumLiteral("none"), Types._InheritanceKind, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InheritanceKind__abstract = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INHERITANCE_KIND.getEEnumLiteral("abstract"), Types._InheritanceKind, 1);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _InheritanceKind__final = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.INHERITANCE_KIND.getEEnumLiteral("final"), Types._InheritanceKind, 2);
		...
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _PostfixExpressionKind__INCREMENT = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.POSTFIX_EXPRESSION_KIND.getEEnumLiteral("INCREMENT"), Types._PostfixExpressionKind, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _PostfixExpressionKind__DECREMENT = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.POSTFIX_EXPRESSION_KIND.getEEnumLiteral("DECREMENT"), Types._PostfixExpressionKind, 1);
		...
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _PrefixExpressionKind__INCREMENT = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.PREFIX_EXPRESSION_KIND.getEEnumLiteral("INCREMENT"), Types._PrefixExpressionKind, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _PrefixExpressionKind__DECREMENT = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.PREFIX_EXPRESSION_KIND.getEEnumLiteral("DECREMENT"), Types._PrefixExpressionKind, 1);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _PrefixExpressionKind__PLUS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.PREFIX_EXPRESSION_KIND.getEEnumLiteral("PLUS"), Types._PrefixExpressionKind, 2);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _PrefixExpressionKind__MINUS = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.PREFIX_EXPRESSION_KIND.getEEnumLiteral("MINUS"), Types._PrefixExpressionKind, 3);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _PrefixExpressionKind__COMPLEMENT = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.PREFIX_EXPRESSION_KIND.getEEnumLiteral("COMPLEMENT"), Types._PrefixExpressionKind, 4);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _PrefixExpressionKind__NOT = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.PREFIX_EXPRESSION_KIND.getEEnumLiteral("NOT"), Types._PrefixExpressionKind, 5);
		...
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _VisibilityKind__none = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.VISIBILITY_KIND.getEEnumLiteral("none"), Types._VisibilityKind, 0);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _VisibilityKind__public = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.VISIBILITY_KIND.getEEnumLiteral("public"), Types._VisibilityKind, 1);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _VisibilityKind__private = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.VISIBILITY_KIND.getEEnumLiteral("private"), Types._VisibilityKind, 2);
		public static final /*@NonNull*/ EcoreExecutorEnumerationLiteral _VisibilityKind__protected = new EcoreExecutorEnumerationLiteral(JavaMMPackage.Literals.VISIBILITY_KIND.getEEnumLiteral("protected"), Types._VisibilityKind, 3);
		...
		/**
		 * Force initialization of the fields of JavaMMTables::EnumerationLiterals and all preceding sub-packages.
		 */
		public static void init() {}
	}
