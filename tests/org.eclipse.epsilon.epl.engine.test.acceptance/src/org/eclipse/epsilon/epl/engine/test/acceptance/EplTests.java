...
public class EplTests {
	...
	public static final IModel TEST_MODEL = setUpModel("test.xml");
	private static final File TEST_SCRIPT = new File(EplAcceptanceTestUtil.scriptsRoot+"test.epl");
	
	@Parameter
	public Supplier<? extends AbstractEplModule> moduleGetter;
	
	private AbstractEplModule module;
	...
	public void testEpl() throws Exception {
		...
		assertNumberOfMatches(1, "NegativeAccessPredecessor");
		assertNumberOfMatches(2, "NegativeAccessSelf");
		assertNumberOfMatches(2, "MultipleInactive");
		assertNumberOfMatches(2, "CardinalityMany");
		assertNumberOfMatches(2, "CardinalityRange");
		assertNumberOfMatches(0, "CardinalityZero");
		assertNumberOfMatches(2, "CardinalityNegative");
		assertNumberOfMatches(2, "OptionalActive");
		assertNumberOfMatches(2, "OptionalInactiveMultipleDomains");
		//assertNumberOfMatches(?, "OptionalNegativeGuard");
		//assertNumberOfMatches(?, "OptionalCardinality");
		//assertNumberOfMatches(?, "KitchenSink");
	}
}
