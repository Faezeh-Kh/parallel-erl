...
import org.eclipse.epsilon.evl.distributed.crossflow.EvlModuleDistributedMasterCrossflow;
...
public class CrossflowEvlRunConfigurationMaster extends DistributedEvlRunConfigurationMaster {
	...
	@Override
	protected EvlModuleDistributedMasterCrossflow getDefaultModule() {
		return new EvlModuleDistributedMasterCrossflow();
	}
}
