 ...
 * @author Sina Madani
 */
public class imdb_count extends ProfilableRunConfiguration {

	static class Builder extends ProfilableRunConfiguration.Builder<imdb_count, Builder> {
		EmfModel model;
		boolean parallel;
		...
		@Override
		public imdb_count build() throws IllegalArgumentException, IllegalStateException {
			return new imdb_count(this);
		}
	}
	
	imdb_count(Builder builder) {
		super(builder);
	...
	public static void main(String... args) throws Exception {
		...
		var jarName = new java.io.File(imdb_count.class
			.getProtectionDomain()
			.getCodeSource()
			.getLocation()
			.getPath()
