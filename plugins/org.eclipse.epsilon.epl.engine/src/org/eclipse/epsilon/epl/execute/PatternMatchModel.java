...
import static org.eclipse.epsilon.common.concurrent.ConcurrencyUtils.concurrentMap;
import static org.eclipse.epsilon.common.concurrent.ConcurrencyUtils.concurrentSet;
...
public class PatternMatchModel extends Model {
	...
	public void setPatterns(Collection<Pattern> patterns) {
		...
		for (Pattern pattern : patterns) {
			...
			matchMap.put(patternName, isConcurrent ? new ConcurrentLinkedDeque<>() : new ArrayList<>());
